...
var file_profile_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x82, 0x04, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	...
	0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43,
	0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x69, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1d, 0x2e, 0x63,
	0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x65, 0x73,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x63, 0x65,
	0x72, 0x61, 0x73, 0x75, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x65, 0x73, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69,
...
var file_profile_proto_goTypes = []interface{}{
	...
	(*CompanyesListRequest)(nil), // 11: cerasus.CompanyesListRequest
	(*PingReply)(nil),            // 12: cerasus.PingReply
	(*BoolReply)(nil),            // 13: cerasus.BoolReply
	(*CompanyesListReply)(nil),   // 14: cerasus.CompanyesListReply
}
var file_profile_proto_depIdxs = []int32{
	...
	11, // 14: cerasus.Profile.GetCompaniesList:input_type -> cerasus.CompanyesListRequest
	12, // 15: cerasus.Profile.Ping:output_type -> cerasus.PingReply
	13, // 16: cerasus.Profile.UpdateCompany:output_type -> cerasus.BoolReply
	2,  // 17: cerasus.Profile.GetRoles:output_type -> cerasus.RolesReply
	13, // 18: cerasus.Profile.CreateUser:output_type -> cerasus.BoolReply
	13, // 19: cerasus.Profile.UpdateUser:output_type -> cerasus.BoolReply
	9,  // 20: cerasus.Profile.GetUser:output_type -> cerasus.User
	6,  // 21: cerasus.Profile.GetCompanyUsers:output_type -> cerasus.UsersReply
	14, // 22: cerasus.Profile.GetCompaniesList:output_type -> cerasus.CompanyesListReply
