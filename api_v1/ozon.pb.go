...
var file_ozon_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x32, 0x87, 0x06, 0x0a, 0x04, 0x4f, 0x7a, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x07,
	...
	0x2e, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23, 0x5a,
...
var file_ozon_proto_goTypes = []interface{}{
	...
	(*CountReply)(nil),             // 9: cerasus.CountReply
	...
	(*SalesReply)(nil),             // 13: cerasus.SalesReply
	(*SaleDetailsReply)(nil),       // 14: cerasus.SaleDetailsReply
}
var file_ozon_proto_depIdxs = []int32{
	...
	8,  // 14: cerasus.Ozon.SetAuth:output_type -> cerasus.BoolReply
	0,  // 15: cerasus.Ozon.GetAuth:output_type -> cerasus.ShopOzonAuth
	8,  // 16: cerasus.Ozon.ErrorAuth:output_type -> cerasus.BoolReply
	9,  // 17: cerasus.Ozon.GetUnsortedCount:output_type -> cerasus.CountReply
	10, // 18: cerasus.Ozon.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	9,  // 19: cerasus.Ozon.GetProductCount:output_type -> cerasus.CountReply
	10, // 20: cerasus.Ozon.GetProductList:output_type -> cerasus.ShopProductListReply
	11, // 21: cerasus.Ozon.GetProduct:output_type -> cerasus.ShopProduct
	12, // 22: cerasus.Ozon.GetDaySales:output_type -> cerasus.DaysSalesReply
	13, // 23: cerasus.Ozon.GetSales:output_type -> cerasus.SalesReply
	14, // 24: cerasus.Ozon.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	13, // 25: cerasus.Ozon.GetProductSales:output_type -> cerasus.SalesReply
