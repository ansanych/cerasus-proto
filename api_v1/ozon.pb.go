...
var file_ozon_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x32, 0x92, 0x08, 0x0a, 0x04, 0x4f, 0x7a, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x07,
	...
	0x12, 0x36, 0x0a, 0x09, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x12, 0x0d, 0x2e,
	...
	0x6f, 0x70, 0x44, 0x61, 0x74, 0x61, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68,
...
var file_ozon_proto_depIdxs = []int32{
	...
	2,  // 17: cerasus.Ozon.CheckAuth:input_type -> cerasus.Auth
	11, // 18: cerasus.Ozon.SetAuth:output_type -> cerasus.BoolReply
	0,  // 19: cerasus.Ozon.GetAuth:output_type -> cerasus.ShopOzonAuth
	11, // 20: cerasus.Ozon.ErrorAuth:output_type -> cerasus.BoolReply
	12, // 21: cerasus.Ozon.GetUnsortedCount:output_type -> cerasus.CountReply
	13, // 22: cerasus.Ozon.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	12, // 23: cerasus.Ozon.GetProductCount:output_type -> cerasus.CountReply
	13, // 24: cerasus.Ozon.GetProductList:output_type -> cerasus.ShopProductListReply
	14, // 25: cerasus.Ozon.GetProduct:output_type -> cerasus.ShopProduct
	15, // 26: cerasus.Ozon.GetDaySales:output_type -> cerasus.DaysSalesReply
	16, // 27: cerasus.Ozon.GetSales:output_type -> cerasus.SalesReply
	17, // 28: cerasus.Ozon.GetShopServices:output_type -> cerasus.ShopServiceReply
	18, // 29: cerasus.Ozon.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	16, // 30: cerasus.Ozon.GetProductSales:output_type -> cerasus.SalesReply
	19, // 31: cerasus.Ozon.GetMainGraphic:output_type -> cerasus.MainGraphicReply
	20, // 32: cerasus.Ozon.GetImage:output_type -> cerasus.ImageReply
	21, // 33: cerasus.Ozon.CheckAuth:output_type -> cerasus.CompanyShopData
