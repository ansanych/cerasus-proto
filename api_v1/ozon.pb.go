...
var file_ozon_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x32, 0xf4, 0x04, 0x0a, 0x04, 0x4f, 0x7a, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x07,
...
var file_ozon_proto_goTypes = []interface{}{
	...
	(*ShopProductListReply)(nil),   // 8: cerasus.ShopProductListReply
	(*ShopProduct)(nil),            // 9: cerasus.ShopProduct
	(*DaysSalesReply)(nil),         // 10: cerasus.DaysSalesReply
	(*SalesReply)(nil),             // 11: cerasus.SalesReply
}
var file_ozon_proto_depIdxs = []int32{
	...
	6,  // 12: cerasus.Ozon.SetAuth:output_type -> cerasus.BoolReply
	0,  // 13: cerasus.Ozon.GetAuth:output_type -> cerasus.ShopOzonAuth
	6,  // 14: cerasus.Ozon.ErrorAuth:output_type -> cerasus.BoolReply
	7,  // 15: cerasus.Ozon.GetUnsortedCount:output_type -> cerasus.CountReply
	8,  // 16: cerasus.Ozon.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	7,  // 17: cerasus.Ozon.GetProductCount:output_type -> cerasus.CountReply
	8,  // 18: cerasus.Ozon.GetProductList:output_type -> cerasus.ShopProductListReply
	9,  // 19: cerasus.Ozon.GetProduct:output_type -> cerasus.ShopProduct
	10, // 20: cerasus.Ozon.GetDaySales:output_type -> cerasus.DaysSalesReply
	11, // 21: cerasus.Ozon.GetSales:output_type -> cerasus.SalesReply
