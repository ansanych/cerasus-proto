...
var file_brand_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x32, 0xde, 0x0b, 0x0a, 0x06, 0x42, 0x72, 0x61, 0x6e,
...
var file_brand_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_brand_proto_goTypes = []interface{}{
	...
	(*Auth)(nil),                         // 20: cerasus.Auth
	(*Company)(nil),                      // 21: cerasus.Company
	(*Product)(nil),                      // 22: cerasus.Product
	(*PingRequest)(nil),                  // 23: cerasus.PingRequest
	(*RequestByID)(nil),                  // 24: cerasus.RequestByID
	(*PingReply)(nil),                    // 25: cerasus.PingReply
...
var file_brand_proto_depIdxs = []int32{
	...
	20, // 1: cerasus.BProductUpsert.auth:type_name -> cerasus.Auth
	0,  // 2: cerasus.BProductUpsert.b_product:type_name -> cerasus.BProduct
	20, // 3: cerasus.BUploadRequest.auth:type_name -> cerasus.Auth
	5,  // 4: cerasus.BPrices.b_prices:type_name -> cerasus.BPrice
	20, // 5: cerasus.BPriceUpsert.auth:type_name -> cerasus.Auth
	5,  // 6: cerasus.BPriceUpsert.b_price:type_name -> cerasus.BPrice
	20, // 7: cerasus.BSellerUpsert.auth:type_name -> cerasus.Auth
	8,  // 8: cerasus.BSellerUpsert.b_seller:type_name -> cerasus.BSeller
	8,  // 9: cerasus.BSellers.b_sellers:type_name -> cerasus.BSeller
	20, // 10: cerasus.BSellerCompanyRequest.auth:type_name -> cerasus.Auth
	21, // 11: cerasus.BSellerCompanyData.company:type_name -> cerasus.Company
	12, // 12: cerasus.BSellerCompaniesData.data:type_name -> cerasus.BSellerCompanyData
	20, // 13: cerasus.BSellerCompanyProductRequest.auth:type_name -> cerasus.Auth
	15, // 14: cerasus.CompanyProductShopUrls.urls:type_name -> cerasus.CompanyProductShopUrl
	22, // 15: cerasus.BSellerCompanyProduct.product:type_name -> cerasus.Product
	...
	20, // 19: cerasus.BSCPUpdateRequest.auth:type_name -> cerasus.Auth
	22, // 20: cerasus.BSCPUpdateRequest.product:type_name -> cerasus.Product
	0,  // 21: cerasus.BSCPUpdateRequest.b_product:type_name -> cerasus.BProduct
	23, // 22: cerasus.Brands.Ping:input_type -> cerasus.PingRequest
	20, // 23: cerasus.Brands.GetBrandData:input_type -> cerasus.Auth
	20, // 24: cerasus.Brands.GetBProducts:input_type -> cerasus.Auth
	24, // 25: cerasus.Brands.GetBProduct:input_type -> cerasus.RequestByID
	2,  // 26: cerasus.Brands.CreateBProduct:input_type -> cerasus.BProductUpsert
	2,  // 27: cerasus.Brands.UpdateBProduct:input_type -> cerasus.BProductUpsert
	24, // 28: cerasus.Brands.DeleteBProduct:input_type -> cerasus.RequestByID
	3,  // 29: cerasus.Brands.GetBFile:input_type -> cerasus.BFileRequest
	4,  // 30: cerasus.Brands.UploadBFile:input_type -> cerasus.BUploadRequest
	24, // 31: cerasus.Brands.GetBPrices:input_type -> cerasus.RequestByID
	24, // 32: cerasus.Brands.GetBPrice:input_type -> cerasus.RequestByID
	7,  // 33: cerasus.Brands.CreateBPrice:input_type -> cerasus.BPriceUpsert
	24, // 34: cerasus.Brands.DeleteBPrice:input_type -> cerasus.RequestByID
	9,  // 35: cerasus.Brands.CreateBSeller:input_type -> cerasus.BSellerUpsert
	20, // 36: cerasus.Brands.GetBSellers:input_type -> cerasus.Auth
	24, // 37: cerasus.Brands.GetBSeller:input_type -> cerasus.RequestByID
	9,  // 38: cerasus.Brands.UpdateBSeller:input_type -> cerasus.BSellerUpsert
	24, // 39: cerasus.Brands.DeleteBSeller:input_type -> cerasus.RequestByID
	11, // 40: cerasus.Brands.GetBSellerCompanies:input_type -> cerasus.BSellerCompanyRequest
	11, // 41: cerasus.Brands.GetBSellerCompany:input_type -> cerasus.BSellerCompanyRequest
	11, // 42: cerasus.Brands.GetBSellerCompanyProducts:input_type -> cerasus.BSellerCompanyRequest
	14, // 43: cerasus.Brands.GetBSellerCompanyProduct:input_type -> cerasus.BSellerCompanyProductRequest
	19, // 44: cerasus.Brands.UpdateBSellerCompanyProduct:input_type -> cerasus.BSCPUpdateRequest
	25, // 45: cerasus.Brands.Ping:output_type -> cerasus.PingReply
	26, // 46: cerasus.Brands.GetBrandData:output_type -> cerasus.Brand
	1,  // 47: cerasus.Brands.GetBProducts:output_type -> cerasus.BProducts
	0,  // 48: cerasus.Brands.GetBProduct:output_type -> cerasus.BProduct
	0,  // 49: cerasus.Brands.CreateBProduct:output_type -> cerasus.BProduct
	27, // 50: cerasus.Brands.UpdateBProduct:output_type -> cerasus.BoolReply
	27, // 51: cerasus.Brands.DeleteBProduct:output_type -> cerasus.BoolReply
	28, // 52: cerasus.Brands.GetBFile:output_type -> cerasus.ImageReply
	28, // 53: cerasus.Brands.UploadBFile:output_type -> cerasus.ImageReply
	6,  // 54: cerasus.Brands.GetBPrices:output_type -> cerasus.BPrices
	5,  // 55: cerasus.Brands.GetBPrice:output_type -> cerasus.BPrice
	5,  // 56: cerasus.Brands.CreateBPrice:output_type -> cerasus.BPrice
	27, // 57: cerasus.Brands.DeleteBPrice:output_type -> cerasus.BoolReply
	8,  // 58: cerasus.Brands.CreateBSeller:output_type -> cerasus.BSeller
	10, // 59: cerasus.Brands.GetBSellers:output_type -> cerasus.BSellers
	8,  // 60: cerasus.Brands.GetBSeller:output_type -> cerasus.BSeller
	27, // 61: cerasus.Brands.UpdateBSeller:output_type -> cerasus.BoolReply
	27, // 62: cerasus.Brands.DeleteBSeller:output_type -> cerasus.BoolReply
	13, // 63: cerasus.Brands.GetBSellerCompanies:output_type -> cerasus.BSellerCompaniesData
	12, // 64: cerasus.Brands.GetBSellerCompany:output_type -> cerasus.BSellerCompanyData
	18, // 65: cerasus.Brands.GetBSellerCompanyProducts:output_type -> cerasus.BSellerCompanyProducts
	17, // 66: cerasus.Brands.GetBSellerCompanyProduct:output_type -> cerasus.BSellerCompanyProduct
	27, // 67: cerasus.Brands.UpdateBSellerCompanyProduct:output_type -> cerasus.BoolReply
