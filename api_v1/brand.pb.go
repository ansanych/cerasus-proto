...
type DumpingRaitingRow struct {
	...
	Pricer   int32   `protobuf:"varint,7,opt,name=pricer,proto3" json:"pricer,omitempty"`
}
...
func (x *DumpingRaitingRow) GetPricer() int32 {
	if x != nil {
		return x.Pricer
	}
	return 0
...
var file_brand_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x06, 0x70, 0x72, 0x69, 0x63, 0x65, 0x72, 0x22, 0x40, 0x0a, 0x0e, 0x44,
