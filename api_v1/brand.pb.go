...
var file_brand_proto_rawDesc = []byte{
	...
	0x64, 0x52, 0x05, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x32, 0x3c, 0x0a, 0x06, 0x42, 0x72, 0x61, 0x6e,
...
var file_brand_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_brand_proto_goTypes = []interface{}{
	...
	(*BProductPrice)(nil), // 4: cerasus.BProductPrice
...
var file_brand_proto_depIdxs = []int32{
	4, // 0: cerasus.BProduct.price:type_name -> cerasus.BProductPrice
	5, // 1: cerasus.BSeller.companiesLink:type_name -> cerasus.Company
	6, // 2: cerasus.BBrandLink.brand:type_name -> cerasus.Brand
	7, // 3: cerasus.Brands.Ping:input_type -> cerasus.PingRequest
	8, // 4: cerasus.Brands.Ping:output_type -> cerasus.PingReply
