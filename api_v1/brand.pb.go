...
var file_brand_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x32, 0xe0, 0x0b, 0x0a, 0x06,
	...
	0x2e, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23,
...
var file_brand_proto_goTypes = []interface{}{
	...
	(*InsertReply)(nil),              // 38: cerasus.InsertReply
}
var file_brand_proto_depIdxs = []int32{
	...
	23, // 50: cerasus.Brands.SetSellerNullCompanyProductLink:input_type -> cerasus.BSCProductLinkRequest
	35, // 51: cerasus.Brands.Ping:output_type -> cerasus.PingReply
	31, // 52: cerasus.Brands.GetCerasusBrandData:output_type -> cerasus.Brand
	5,  // 53: cerasus.Brands.GetBProducts:output_type -> cerasus.BProductsReply
	2,  // 54: cerasus.Brands.GetBProduct:output_type -> cerasus.BProduct
	6,  // 55: cerasus.Brands.CreateBProducts:output_type -> cerasus.BProductCreateReply
	36, // 56: cerasus.Brands.UpdateBProducts:output_type -> cerasus.BoolReply
	0,  // 57: cerasus.Brands.GetBPrices:output_type -> cerasus.BProductPrices
	27, // 58: cerasus.Brands.GetBPrice:output_type -> cerasus.BProductPrice
	27, // 59: cerasus.Brands.SetBPrice:output_type -> cerasus.BProductPrice
	13, // 60: cerasus.Brands.GetBSellers:output_type -> cerasus.BSellers
	11, // 61: cerasus.Brands.GetBSeller:output_type -> cerasus.BSeller
	11, // 62: cerasus.Brands.CreateBSeller:output_type -> cerasus.BSeller
	36, // 63: cerasus.Brands.UpdateBSeller:output_type -> cerasus.BoolReply
	37, // 64: cerasus.Brands.UploadBFile:output_type -> cerasus.ImageReply
	37, // 65: cerasus.Brands.GetBFile:output_type -> cerasus.ImageReply
	14, // 66: cerasus.Brands.GetBrandLink:output_type -> cerasus.BBrandLink
	10, // 67: cerasus.Brands.GetSellerLinked:output_type -> cerasus.BSellerCompanies
	22, // 68: cerasus.Brands.GetSellerCompanyProducts:output_type -> cerasus.BSCProductsReply
	36, // 69: cerasus.Brands.SetSellerCompanyProductLink:output_type -> cerasus.BoolReply
	25, // 70: cerasus.Brands.GetSellerUnlinkedCount:output_type -> cerasus.SellerUnlinkedCountReply
	36, // 71: cerasus.Brands.ConnectBSellerCompanyShop:output_type -> cerasus.BoolReply
	38, // 72: cerasus.Brands.SetSellerNullCompanyProductLink:output_type -> cerasus.InsertReply
