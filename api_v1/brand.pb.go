...
func (x *BSCProductsRequest) GetBrandID() int64 {
	if x != nil {
		return x.BrandID
	}
	return 0
...
func (x *BSCProductsReply) GetProducts() []*Product {
	if x != nil {
		return x.Products
	}
	return nil
...
var file_brand_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x69, 0x65, 0x73, 0x22, 0x6f, 0x0a, 0x12,
	...
	0x79, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x49, 0x44, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x49, 0x44, 0x22, 0x40, 0x0a,
	0x10, 0x42, 0x53, 0x43, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x2c, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x2e, 0x50, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x32,
	0x94, 0x09, 0x0a, 0x06, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x73, 0x12, 0x32, 0x0a, 0x04, 0x50, 0x69,
...
var file_brand_proto_goTypes = []interface{}{
	...
	(*BSCProductsReply)(nil),      // 18: cerasus.BSCProductsReply
	(*BProductPrice)(nil),         // 19: cerasus.BProductPrice
	(*Auth)(nil),                  // 20: cerasus.Auth
	(*Pagination)(nil),            // 21: cerasus.Pagination
	(*Company)(nil),               // 22: cerasus.Company
	(*Brand)(nil),                 // 23: cerasus.Brand
	(*Product)(nil),               // 24: cerasus.Product
	(*PingRequest)(nil),           // 25: cerasus.PingRequest
	(*PingReply)(nil),             // 26: cerasus.PingReply
	(*BoolReply)(nil),             // 27: cerasus.BoolReply
	(*ImageReply)(nil),            // 28: cerasus.ImageReply
	(*CompanyesListReply)(nil),    // 29: cerasus.CompanyesListReply
}
var file_brand_proto_depIdxs = []int32{
	19, // 0: cerasus.BProductPrices.prices:type_name -> cerasus.BProductPrice
	20, // 1: cerasus.BProductCreatePrice.auth:type_name -> cerasus.Auth
	19, // 2: cerasus.BProduct.price:type_name -> cerasus.BProductPrice
	20, // 3: cerasus.BProductsRequest.auth:type_name -> cerasus.Auth
	20, // 4: cerasus.BIDRequest.auth:type_name -> cerasus.Auth
	2,  // 5: cerasus.BProductsReply.products:type_name -> cerasus.BProduct
	21, // 6: cerasus.BProductsReply.pagination:type_name -> cerasus.Pagination
	2,  // 7: cerasus.BProductCreateReply.product:type_name -> cerasus.BProduct
	20, // 8: cerasus.BProductCreateRequest.auth:type_name -> cerasus.Auth
	2,  // 9: cerasus.BProductCreateRequest.product:type_name -> cerasus.BProduct
	22, // 10: cerasus.BSeller.companiesLink:type_name -> cerasus.Company
	20, // 11: cerasus.BSellerCreateRequest.auth:type_name -> cerasus.Auth
	...
	23, // 14: cerasus.BBrandLink.brand:type_name -> cerasus.Brand
	20, // 15: cerasus.BUploadRequest.auth:type_name -> cerasus.Auth
	22, // 16: cerasus.BSellerLinks.companies:type_name -> cerasus.Company
	20, // 17: cerasus.BSCProductsRequest.auth:type_name -> cerasus.Auth
	24, // 18: cerasus.BSCProductsReply.products:type_name -> cerasus.Product
	25, // 19: cerasus.Brands.Ping:input_type -> cerasus.PingRequest
	20, // 20: cerasus.Brands.GetCerasusBrandData:input_type -> cerasus.Auth
	3,  // 21: cerasus.Brands.GetBProducts:input_type -> cerasus.BProductsRequest
	4,  // 22: cerasus.Brands.GetBProduct:input_type -> cerasus.BIDRequest
	7,  // 23: cerasus.Brands.CreateBProducts:input_type -> cerasus.BProductCreateRequest
	7,  // 24: cerasus.Brands.UpdateBProducts:input_type -> cerasus.BProductCreateRequest
	20, // 25: cerasus.Brands.GetBPrices:input_type -> cerasus.Auth
	4,  // 26: cerasus.Brands.GetBPrice:input_type -> cerasus.BIDRequest
	1,  // 27: cerasus.Brands.SetBPrice:input_type -> cerasus.BProductCreatePrice
	20, // 28: cerasus.Brands.GetBSellers:input_type -> cerasus.Auth
	4,  // 29: cerasus.Brands.GetBSeller:input_type -> cerasus.BIDRequest
	10, // 30: cerasus.Brands.CreateBSeller:input_type -> cerasus.BSellerCreateRequest
	10, // 31: cerasus.Brands.UpdateBSeller:input_type -> cerasus.BSellerCreateRequest
	14, // 32: cerasus.Brands.UploadBFile:input_type -> cerasus.BUploadRequest
	15, // 33: cerasus.Brands.GetBFile:input_type -> cerasus.BFileRequest
	13, // 34: cerasus.Brands.GetBrandLink:input_type -> cerasus.BrandLinkRequest
	4,  // 35: cerasus.Brands.GetSellerLinked:input_type -> cerasus.BIDRequest
	17, // 36: cerasus.Brands.GetSellerCompanyProducts:input_type -> cerasus.BSCProductsRequest
	26, // 37: cerasus.Brands.Ping:output_type -> cerasus.PingReply
	23, // 38: cerasus.Brands.GetCerasusBrandData:output_type -> cerasus.Brand
	5,  // 39: cerasus.Brands.GetBProducts:output_type -> cerasus.BProductsReply
	2,  // 40: cerasus.Brands.GetBProduct:output_type -> cerasus.BProduct
	6,  // 41: cerasus.Brands.CreateBProducts:output_type -> cerasus.BProductCreateReply
	27, // 42: cerasus.Brands.UpdateBProducts:output_type -> cerasus.BoolReply
	0,  // 43: cerasus.Brands.GetBPrices:output_type -> cerasus.BProductPrices
	19, // 44: cerasus.Brands.GetBPrice:output_type -> cerasus.BProductPrice
	19, // 45: cerasus.Brands.SetBPrice:output_type -> cerasus.BProductPrice
	11, // 46: cerasus.Brands.GetBSellers:output_type -> cerasus.BSellers
	9,  // 47: cerasus.Brands.GetBSeller:output_type -> cerasus.BSeller
	9,  // 48: cerasus.Brands.CreateBSeller:output_type -> cerasus.BSeller
	27, // 49: cerasus.Brands.UpdateBSeller:output_type -> cerasus.BoolReply
	28, // 50: cerasus.Brands.UploadBFile:output_type -> cerasus.ImageReply
	28, // 51: cerasus.Brands.GetBFile:output_type -> cerasus.ImageReply
	12, // 52: cerasus.Brands.GetBrandLink:output_type -> cerasus.BBrandLink
	29, // 53: cerasus.Brands.GetSellerLinked:output_type -> cerasus.CompanyesListReply
	18, // 54: cerasus.Brands.GetSellerCompanyProducts:output_type -> cerasus.BSCProductsReply
