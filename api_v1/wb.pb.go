...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xee, 0x04,
	...
	0x73, 0x2e, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23,
...
var file_wb_proto_depIdxs = []int32{
	...
	6,  // 12: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 13: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	6,  // 14: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	7,  // 15: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	8,  // 16: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	7,  // 17: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	8,  // 18: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	9,  // 19: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	10, // 20: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	11, // 21: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
