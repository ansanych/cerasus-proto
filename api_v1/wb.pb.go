...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0x87, 0x09,
	...
	,
...
var file_wb_proto_depIdxs = []int32{
	...
	2,  // 18: cerasus.WB.GetDonutGraphics:input_type -> cerasus.Auth
	2,  // 19: cerasus.WB.GetWeekGraphics:input_type -> cerasus.Auth
	11, // 20: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 21: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	11, // 22: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	12, // 23: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	13, // 24: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	12, // 25: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	13, // 26: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	14, // 27: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	15, // 28: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	16, // 29: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	17, // 30: cerasus.WB.GetShopServices:output_type -> cerasus.ShopServiceReply
	18, // 31: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	16, // 32: cerasus.WB.GetProductSales:output_type -> cerasus.SalesReply
	19, // 33: cerasus.WB.GetMainGraphic:output_type -> cerasus.MainGraphicReply
	20, // 34: cerasus.WB.GetImage:output_type -> cerasus.ImageReply
	21, // 35: cerasus.WB.CheckShopData:output_type -> cerasus.CompanyShopData
	22, // 36: cerasus.WB.GetDonutGraphics:output_type -> cerasus.DonutGraphic
	23, // 37: cerasus.WB.GetWeekGraphics:output_type -> cerasus.WeekGraphics
