...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0x81, 0x06,
...
var file_wb_proto_depIdxs = []int32{
	...
	8,  // 14: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 15: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	8,  // 16: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	9,  // 17: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	10, // 18: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	9,  // 19: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	10, // 20: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	11, // 21: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	12, // 22: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	13, // 23: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	14, // 24: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	13, // 25: cerasus.WB.GetProductSales:output_type -> cerasus.SalesReply
