...
var file_wb_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x73, 0x32, 0xb8, 0x0c, 0x0a, 0x02, 0x57, 0x42, 0x12,
	...
	,
...
var file_wb_proto_depIdxs = []int32{
	...
	17, // 26: cerasus.WB.GetProductUrls:input_type -> cerasus.IDRequest
	18, // 27: cerasus.WB.ForBrandSales:input_type -> cerasus.ForBrandSalesRequest
	19, // 28: cerasus.WB.ForBrandOrders:input_type -> cerasus.ForBrandOrdersRequest
	20, // 29: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 30: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	20, // 31: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	21, // 32: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	22, // 33: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	21, // 34: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	22, // 35: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	23, // 36: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	20, // 37: cerasus.WB.UpdateProduct:output_type -> cerasus.BoolReply
	24, // 38: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	25, // 39: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	26, // 40: cerasus.WB.GetShopServices:output_type -> cerasus.ShopServiceReply
	27, // 41: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	25, // 42: cerasus.WB.GetProductSales:output_type -> cerasus.SalesReply
	28, // 43: cerasus.WB.GetMainGraphic:output_type -> cerasus.MainGraphicReply
	29, // 44: cerasus.WB.GetImage:output_type -> cerasus.ImageReply
	30, // 45: cerasus.WB.CheckShopData:output_type -> cerasus.CompanyShopData
	31, // 46: cerasus.WB.GetDonutGraphics:output_type -> cerasus.DonutGraphic
	32, // 47: cerasus.WB.GetWeekGraphics:output_type -> cerasus.WeekGraphics
	5,  // 48: cerasus.WB.ForCounterDataWB:output_type -> cerasus.ForCounterReplyWB
	33, // 49: cerasus.WB.Ping:output_type -> cerasus.PingReply
	34, // 50: cerasus.WB.GetProductUrls:output_type -> cerasus.ProductShopUrls
	35, // 51: cerasus.WB.ForBrandSales:output_type -> cerasus.ForBrandSalesReply
	36, // 52: cerasus.WB.ForBrandOrders:output_type -> cerasus.ForBrandOrdersReply
