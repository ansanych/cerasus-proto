...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xb9, 0x05,
	...
	0x6c, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74,
...
var file_wb_proto_depIdxs = []int32{
	...
	7,  // 13: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 14: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	7,  // 15: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	8,  // 16: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	9,  // 17: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	8,  // 18: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	9,  // 19: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	10, // 20: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	11, // 21: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	12, // 22: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	13, // 23: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
