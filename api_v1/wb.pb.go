...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xd1, 0x09,
...
var file_wb_proto_depIdxs = []int32{
	...
	5,  // 10: cerasus.WB.UpdateProduct:input_type -> cerasus.ShopProductUpdateRequest
	2,  // 11: cerasus.WB.GetDaySales:input_type -> cerasus.Auth
	6,  // 12: cerasus.WB.GetSales:input_type -> cerasus.SalesRequest
	7,  // 13: cerasus.WB.GetShopServices:input_type -> cerasus.ShopServiceRequest
	8,  // 14: cerasus.WB.GetSaleDetail:input_type -> cerasus.SaleDetailsRequest
	9,  // 15: cerasus.WB.GetProductSales:input_type -> cerasus.ProductSalesRequest
	10, // 16: cerasus.WB.GetMainGraphic:input_type -> cerasus.MainGraphicRequest
	11, // 17: cerasus.WB.GetImage:input_type -> cerasus.ImageRequest
	2,  // 18: cerasus.WB.CheckShopData:input_type -> cerasus.Auth
	2,  // 19: cerasus.WB.GetDonutGraphics:input_type -> cerasus.Auth
	2,  // 20: cerasus.WB.GetWeekGraphics:input_type -> cerasus.Auth
	12, // 21: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 22: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	12, // 23: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	13, // 24: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	14, // 25: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	13, // 26: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	14, // 27: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	15, // 28: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	12, // 29: cerasus.WB.UpdateProduct:output_type -> cerasus.BoolReply
	16, // 30: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	17, // 31: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	18, // 32: cerasus.WB.GetShopServices:output_type -> cerasus.ShopServiceReply
	19, // 33: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	17, // 34: cerasus.WB.GetProductSales:output_type -> cerasus.SalesReply
	20, // 35: cerasus.WB.GetMainGraphic:output_type -> cerasus.MainGraphicReply
	21, // 36: cerasus.WB.GetImage:output_type -> cerasus.ImageReply
	22, // 37: cerasus.WB.CheckShopData:output_type -> cerasus.CompanyShopData
	23, // 38: cerasus.WB.GetDonutGraphics:output_type -> cerasus.DonutGraphic
	24, // 39: cerasus.WB.GetWeekGraphics:output_type -> cerasus.WeekGraphics
