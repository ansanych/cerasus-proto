...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xd4, 0x07,
...
var file_wb_proto_depIdxs = []int32{
	...
	11, // 17: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 18: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	11, // 19: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	12, // 20: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	13, // 21: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	12, // 22: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	13, // 23: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	14, // 24: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	15, // 25: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	16, // 26: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	17, // 27: cerasus.WB.GetShopServices:output_type -> cerasus.ShopServiceReply
	18, // 28: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	16, // 29: cerasus.WB.GetProductSales:output_type -> cerasus.SalesReply
	19, // 30: cerasus.WB.GetMainGraphic:output_type -> cerasus.MainGraphicReply
	20, // 31: cerasus.WB.GetImage:output_type -> cerasus.ImageReply
