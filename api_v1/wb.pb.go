...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xb4, 0x04,
	...
	0x73, 0x75, 0x73, 0x2e, 0x64, 0x61, 0x79, 0x73, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x70,
...
var file_wb_proto_depIdxs = []int32{
	...
	5,  // 11: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 12: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	5,  // 13: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	6,  // 14: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	7,  // 15: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	6,  // 16: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	7,  // 17: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	8,  // 18: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	9,  // 19: cerasus.WB.GetDaySales:output_type -> cerasus.daysSalesReply
