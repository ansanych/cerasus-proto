...
var file_wb_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xcd, 0x06,
	...
	0x73, 0x2e, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x49,
	...
	0x72, 0x61, 0x70, 0x68, 0x69, 0x63, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23, 0x5a,
...
var file_wb_proto_depIdxs = []int32{
	...
	6,  // 12: cerasus.WB.GetSaleDetail:input_type -> cerasus.SaleDetailsRequest
	7,  // 13: cerasus.WB.GetProductSales:input_type -> cerasus.ProductSalesRequest
	8,  // 14: cerasus.WB.GetMainGraphic:input_type -> cerasus.MainGraphicRequest
	9,  // 15: cerasus.WB.SetAuth:output_type -> cerasus.BoolReply
	0,  // 16: cerasus.WB.GetAuth:output_type -> cerasus.ShopWBAuth
	9,  // 17: cerasus.WB.ErrorAuth:output_type -> cerasus.BoolReply
	10, // 18: cerasus.WB.GetUnsortedCount:output_type -> cerasus.CountReply
	11, // 19: cerasus.WB.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	10, // 20: cerasus.WB.GetProductCount:output_type -> cerasus.CountReply
	11, // 21: cerasus.WB.GetProductList:output_type -> cerasus.ShopProductListReply
	12, // 22: cerasus.WB.GetProduct:output_type -> cerasus.ShopProduct
	13, // 23: cerasus.WB.GetDaySales:output_type -> cerasus.DaysSalesReply
	14, // 24: cerasus.WB.GetSales:output_type -> cerasus.SalesReply
	15, // 25: cerasus.WB.GetSaleDetail:output_type -> cerasus.SaleDetailsReply
	14, // 26: cerasus.WB.GetProductSales:output_type -> cerasus.SalesReply
	16, // 27: cerasus.WB.GetMainGraphic:output_type -> cerasus.MainGraphicReply
