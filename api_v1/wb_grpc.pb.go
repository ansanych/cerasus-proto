...
func (c *wBClient) GetProductUrls(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*ProductShopUrls, error) {
	out := new(ProductShopUrls)
	err := c.cc.Invoke(ctx, "/cerasus.WB/GetProductUrls", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wBClient) ForBrandOrders(ctx context.Context, in *ForBrandOrdersRequest, opts ...grpc.CallOption) (*ForBrandOrdersReply, error) {
	out := new(ForBrandOrdersReply)
	err := c.cc.Invoke(ctx, "/cerasus.WB/ForBrandOrders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWBServer) ForBrandOrders(context.Context, *ForBrandOrdersRequest) (*ForBrandOrdersReply, error) {
...
func _WB_GetProductUrls_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WBServer).GetProductUrls(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus.WB/GetProductUrls",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).GetProductUrls(ctx, req.(*IDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WB_ForBrandOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ForBrandOrdersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WBServer).ForBrandOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus.WB/ForBrandOrders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).ForBrandOrders(ctx, req.(*ForBrandOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WB_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WB_ForBrandOrders_Handler,
		},
	},
