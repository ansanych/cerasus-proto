...
type BrandsClient interface {
	...
	GetDumpingCalenderDay(ctx context.Context, in *DumpingDayRequest, opts ...grpc.CallOption) (*DumpingDayReply, error)
	GetDumpingRaiting(ctx context.Context, in *Auth, opts ...grpc.CallOption) (*DumpingRaiting, error)
}
...
func (c *brandsClient) GetDumpingCalenderDay(ctx context.Context, in *DumpingDayRequest, opts ...grpc.CallOption) (*DumpingDayReply, error) {
	out := new(DumpingDayReply)
	err := c.cc.Invoke(ctx, "/cerasus.Brands/GetDumpingCalenderDay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brandsClient) GetDumpingRaiting(ctx context.Context, in *Auth, opts ...grpc.CallOption) (*DumpingRaiting, error) {
	out := new(DumpingRaiting)
	err := c.cc.Invoke(ctx, "/cerasus.Brands/GetDumpingRaiting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BrandsServer interface {
	...
	GetDumpingCalenderDay(context.Context, *DumpingDayRequest) (*DumpingDayReply, error)
	GetDumpingRaiting(context.Context, *Auth) (*DumpingRaiting, error)
...
func (UnimplementedBrandsServer) GetDumpingCalenderDay(context.Context, *DumpingDayRequest) (*DumpingDayReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDumpingCalenderDay not implemented")
}
func (UnimplementedBrandsServer) GetDumpingRaiting(context.Context, *Auth) (*DumpingRaiting, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDumpingRaiting not implemented")
}
...
func _Brands_GetDumpingCalenderDay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DumpingDayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrandsServer).GetDumpingCalenderDay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus.Brands/GetDumpingCalenderDay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrandsServer).GetDumpingCalenderDay(ctx, req.(*DumpingDayRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Brands_GetDumpingRaiting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Auth)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrandsServer).GetDumpingRaiting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus.Brands/GetDumpingRaiting",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrandsServer).GetDumpingRaiting(ctx, req.(*Auth))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Brands_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDumpingCalenderDay",
			Handler:    _Brands_GetDumpingCalenderDay_Handler,
		},
		{
			MethodName: "GetDumpingRaiting",
			Handler:    _Brands_GetDumpingRaiting_Handler,
		},
	},
