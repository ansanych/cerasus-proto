...
var file_products_proto_rawDesc = []byte{
	...
	0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x32, 0xc6, 0x09, 0x0a, 0x08, 0x50,
...
var file_products_proto_goTypes = []interface{}{
	...
	(*Pagination)(nil),                 // 16: cerasus.Pagination
	(*Auth)(nil),                       // 17: cerasus.Auth
	(*Filter)(nil),                     // 18: cerasus.Filter
	(*Sorting)(nil),                    // 19: cerasus.Sorting
	(*DeleteRequest)(nil),              // 20: cerasus.DeleteRequest
	(*SearchRequest)(nil),              // 21: cerasus.SearchRequest
	(*BoolReply)(nil),                  // 22: cerasus.BoolReply
}
var file_products_proto_depIdxs = []int32{
	...
	16, // 2: cerasus.ProductsReply.pagination:type_name -> cerasus.Pagination
	17, // 3: cerasus.ProductRequest.auth:type_name -> cerasus.Auth
	17, // 4: cerasus.ShopProductPurcasesRequest.auth:type_name -> cerasus.Auth
	17, // 5: cerasus.ProductListRequest.auth:type_name -> cerasus.Auth
	18, // 6: cerasus.ProductListRequest.filters:type_name -> cerasus.Filter
	19, // 7: cerasus.ProductListRequest.sort:type_name -> cerasus.Sorting
	17, // 8: cerasus.ProductLink.auth:type_name -> cerasus.Auth
	6,  // 9: cerasus.ProductsLinks.links:type_name -> cerasus.ProductLink
	17, // 10: cerasus.CheckLinksReqest.auth:type_name -> cerasus.Auth
	17, // 11: cerasus.UpdateProductRequest.auth:type_name -> cerasus.Auth
	17, // 12: cerasus.SetProductBrandRequest.auth:type_name -> cerasus.Auth
	17, // 13: cerasus.SetProductPurchaseRequest.auth:type_name -> cerasus.Auth
	12, // 14: cerasus.PurchasesReply.purchases:type_name -> cerasus.ProductPurchase
	17, // 15: cerasus.ListIDRequest.auth:type_name -> cerasus.Auth
	...
	20, // 27: cerasus.Products.RemoveProductPurchase:input_type -> cerasus.DeleteRequest
	21, // 28: cerasus.Products.SearchProduct:input_type -> cerasus.SearchRequest
	...
	2,  // 33: cerasus.Products.GetProducts:output_type -> cerasus.ProductsReply
	1,  // 34: cerasus.Products.GetProduct:output_type -> cerasus.Product
	22, // 35: cerasus.Products.CreateFromShop:output_type -> cerasus.BoolReply
	22, // 36: cerasus.Products.LinkToShop:output_type -> cerasus.BoolReply
	22, // 37: cerasus.Products.UnlinkToShop:output_type -> cerasus.BoolReply
	22, // 38: cerasus.Products.UpdateProduct:output_type -> cerasus.BoolReply
	22, // 39: cerasus.Products.SetProductBrand:output_type -> cerasus.BoolReply
	22, // 40: cerasus.Products.RemoveProductBrand:output_type -> cerasus.BoolReply
	22, // 41: cerasus.Products.SetProductPurchase:output_type -> cerasus.BoolReply
	12, // 42: cerasus.Products.GetProductPurchase:output_type -> cerasus.ProductPurchase
	13, // 43: cerasus.Products.GetProductPurchases:output_type -> cerasus.PurchasesReply
	22, // 44: cerasus.Products.RemoveProductPurchase:output_type -> cerasus.BoolReply
	2,  // 45: cerasus.Products.SearchProduct:output_type -> cerasus.ProductsReply
	7,  // 46: cerasus.Products.CheckLinkedShopProducts:output_type -> cerasus.ProductsLinks
	6,  // 47: cerasus.Products.CheckLinkedShopProduct:output_type -> cerasus.ProductLink
	15, // 48: cerasus.Products.GetCompanyProductsID:output_type -> cerasus.ListID
	13, // 49: cerasus.Products.GetShopProductPurcases:output_type -> cerasus.PurchasesReply
