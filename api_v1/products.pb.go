...
var file_products_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x2e, 0x0a, 0x06, 0x4c, 0x69,
	0x73, 0x74, 0x49, 0x44, 0x12, 0x24, 0x0a, 0x0d, 0x73, 0x68, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x49, 0x44, 0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0d, 0x73, 0x68, 0x6f,
	0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x22, 0x58, 0x0a, 0x14, 0x50, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x73, 0x68, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x49, 0x44, 0x32, 0x8f, 0x0a, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
...
var file_products_proto_goTypes = []interface{}{
	...
	(*ListID)(nil),                     // 15: cerasus.ListID
	(*ProductByShopRequest)(nil),       // 16: cerasus.ProductByShopRequest
	(*Pagination)(nil),                 // 17: cerasus.Pagination
...
var file_products_proto_depIdxs = []int32{
	...
	17, // 2: cerasus.ProductsReply.pagination:type_name -> cerasus.Pagination
	18, // 3: cerasus.ProductRequest.auth:type_name -> cerasus.Auth
	18, // 4: cerasus.ShopProductPurcasesRequest.auth:type_name -> cerasus.Auth
	18, // 5: cerasus.ProductListRequest.auth:type_name -> cerasus.Auth
	19, // 6: cerasus.ProductListRequest.filters:type_name -> cerasus.Filter
	20, // 7: cerasus.ProductListRequest.sort:type_name -> cerasus.Sorting
	18, // 8: cerasus.ProductLink.auth:type_name -> cerasus.Auth
	6,  // 9: cerasus.ProductsLinks.links:type_name -> cerasus.ProductLink
	18, // 10: cerasus.CheckLinksReqest.auth:type_name -> cerasus.Auth
	18, // 11: cerasus.UpdateProductRequest.auth:type_name -> cerasus.Auth
	18, // 12: cerasus.SetProductBrandRequest.auth:type_name -> cerasus.Auth
	18, // 13: cerasus.SetProductPurchaseRequest.auth:type_name -> cerasus.Auth
	12, // 14: cerasus.PurchasesReply.purchases:type_name -> cerasus.ProductPurchase
	18, // 15: cerasus.ListIDRequest.auth:type_name -> cerasus.Auth
	5,  // 16: cerasus.Products.GetProducts:input_type -> cerasus.ProductListRequest
	3,  // 17: cerasus.Products.GetProduct:input_type -> cerasus.ProductRequest
	6,  // 18: cerasus.Products.CreateFromShop:input_type -> cerasus.ProductLink
	6,  // 19: cerasus.Products.LinkToShop:input_type -> cerasus.ProductLink
	6,  // 20: cerasus.Products.UnlinkToShop:input_type -> cerasus.ProductLink
	9,  // 21: cerasus.Products.UpdateProduct:input_type -> cerasus.UpdateProductRequest
	10, // 22: cerasus.Products.SetProductBrand:input_type -> cerasus.SetProductBrandRequest
	10, // 23: cerasus.Products.RemoveProductBrand:input_type -> cerasus.SetProductBrandRequest
	11, // 24: cerasus.Products.SetProductPurchase:input_type -> cerasus.SetProductPurchaseRequest
	3,  // 25: cerasus.Products.GetProductPurchase:input_type -> cerasus.ProductRequest
	3,  // 26: cerasus.Products.GetProductPurchases:input_type -> cerasus.ProductRequest
	21, // 27: cerasus.Products.RemoveProductPurchase:input_type -> cerasus.DeleteRequest
	22, // 28: cerasus.Products.SearchProduct:input_type -> cerasus.SearchRequest
	8,  // 29: cerasus.Products.CheckLinkedShopProducts:input_type -> cerasus.CheckLinksReqest
	8,  // 30: cerasus.Products.CheckLinkedShopProduct:input_type -> cerasus.CheckLinksReqest
	14, // 31: cerasus.Products.GetCompanyProductsID:input_type -> cerasus.ListIDRequest
	4,  // 32: cerasus.Products.GetShopProductPurcases:input_type -> cerasus.ShopProductPurcasesRequest
	16, // 33: cerasus.Products.GetProductByShopID:input_type -> cerasus.ProductByShopRequest
	2,  // 34: cerasus.Products.GetProducts:output_type -> cerasus.ProductsReply
	1,  // 35: cerasus.Products.GetProduct:output_type -> cerasus.Product
	23, // 36: cerasus.Products.CreateFromShop:output_type -> cerasus.BoolReply
	23, // 37: cerasus.Products.LinkToShop:output_type -> cerasus.BoolReply
	23, // 38: cerasus.Products.UnlinkToShop:output_type -> cerasus.BoolReply
	23, // 39: cerasus.Products.UpdateProduct:output_type -> cerasus.BoolReply
	23, // 40: cerasus.Products.SetProductBrand:output_type -> cerasus.BoolReply
	23, // 41: cerasus.Products.RemoveProductBrand:output_type -> cerasus.BoolReply
	23, // 42: cerasus.Products.SetProductPurchase:output_type -> cerasus.BoolReply
	12, // 43: cerasus.Products.GetProductPurchase:output_type -> cerasus.ProductPurchase
	13, // 44: cerasus.Products.GetProductPurchases:output_type -> cerasus.PurchasesReply
	23, // 45: cerasus.Products.RemoveProductPurchase:output_type -> cerasus.BoolReply
	2,  // 46: cerasus.Products.SearchProduct:output_type -> cerasus.ProductsReply
	7,  // 47: cerasus.Products.CheckLinkedShopProducts:output_type -> cerasus.ProductsLinks
	6,  // 48: cerasus.Products.CheckLinkedShopProduct:output_type -> cerasus.ProductLink
	15, // 49: cerasus.Products.GetCompanyProductsID:output_type -> cerasus.ListID
	13, // 50: cerasus.Products.GetShopProductPurcases:output_type -> cerasus.PurchasesReply
	1,  // 51: cerasus.Products.GetProductByShopID:output_type -> cerasus.Product
