...
var file_products_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x32, 0xba, 0x09,
	...
	0x73, 0x75, 0x73, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x44, 0x22, 0x00, 0x12, 0x4c, 0x0a, 0x16,
	0x47, 0x65, 0x74, 0x53, 0x68, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x50, 0x75,
	0x72, 0x63, 0x61, 0x73, 0x65, 0x73, 0x12, 0x17, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73,
	...
	0x73, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69,
...
var file_products_proto_depIdxs = []int32{
	...
	3,  // 31: cerasus.Products.GetShopProductPurcases:input_type -> cerasus.ProductRequest
	2,  // 32: cerasus.Products.GetProducts:output_type -> cerasus.ProductsReply
	1,  // 33: cerasus.Products.GetProduct:output_type -> cerasus.Product
	21, // 34: cerasus.Products.CreateFromShop:output_type -> cerasus.BoolReply
	21, // 35: cerasus.Products.LinkToShop:output_type -> cerasus.BoolReply
	21, // 36: cerasus.Products.UnlinkToShop:output_type -> cerasus.BoolReply
	21, // 37: cerasus.Products.UpdateProduct:output_type -> cerasus.BoolReply
	21, // 38: cerasus.Products.SetProductBrand:output_type -> cerasus.BoolReply
	21, // 39: cerasus.Products.RemoveProductBrand:output_type -> cerasus.BoolReply
	21, // 40: cerasus.Products.SetProductPurchase:output_type -> cerasus.BoolReply
	11, // 41: cerasus.Products.GetProductPurchase:output_type -> cerasus.ProductPurchase
	12, // 42: cerasus.Products.GetProductPurchases:output_type -> cerasus.PurchasesReply
	21, // 43: cerasus.Products.RemoveProductPurchase:output_type -> cerasus.BoolReply
	2,  // 44: cerasus.Products.SearchProduct:output_type -> cerasus.ProductsReply
	6,  // 45: cerasus.Products.CheckLinkedShopProducts:output_type -> cerasus.ProductsLinks
	5,  // 46: cerasus.Products.CheckLinkedShopProduct:output_type -> cerasus.ProductLink
	14, // 47: cerasus.Products.GetCompanyProductsID:output_type -> cerasus.ListID
	12, // 48: cerasus.Products.GetShopProductPurcases:output_type -> cerasus.PurchasesReply
