...
var file_ym_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0x8c, 0x02,
...
var file_ym_proto_goTypes = []interface{}{
	...
	(*CompanyShopData)(nil), // 6: cerasus.CompanyShopData
}
var file_ym_proto_depIdxs = []int32{
	...
	4, // 7: cerasus.YM.SetAuth:output_type -> cerasus.BoolReply
	0, // 8: cerasus.YM.GetAuth:output_type -> cerasus.ShopYMAuth
	4, // 9: cerasus.YM.ErrorAuth:output_type -> cerasus.BoolReply
	5, // 10: cerasus.YM.Ping:output_type -> cerasus.PingReply
	6, // 11: cerasus.YM.CheckShopData:output_type -> cerasus.CompanyShopData
