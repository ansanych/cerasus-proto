...
var file_ym_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x41, 0x75, 0x74, 0x68, 0x32, 0xb5, 0x05,
...
var file_ym_proto_goTypes = []interface{}{
	...
	(*PingReply)(nil),                // 8: cerasus.PingReply
	(*CompanyShopData)(nil),          // 9: cerasus.CompanyShopData
...
var file_ym_proto_depIdxs = []int32{
	...
	7,  // 13: cerasus.YM.SetAuth:output_type -> cerasus.BoolReply
	0,  // 14: cerasus.YM.GetAuth:output_type -> cerasus.ShopYMAuth
	7,  // 15: cerasus.YM.ErrorAuth:output_type -> cerasus.BoolReply
	8,  // 16: cerasus.YM.Ping:output_type -> cerasus.PingReply
	9,  // 17: cerasus.YM.CheckShopData:output_type -> cerasus.CompanyShopData
	10, // 18: cerasus.YM.GetUnsortedCount:output_type -> cerasus.CountReply
	11, // 19: cerasus.YM.GetUnsortedList:output_type -> cerasus.ShopProductListReply
	10, // 20: cerasus.YM.GetProductCount:output_type -> cerasus.CountReply
	11, // 21: cerasus.YM.GetProductList:output_type -> cerasus.ShopProductListReply
	12, // 22: cerasus.YM.GetProduct:output_type -> cerasus.ShopProduct
	7,  // 23: cerasus.YM.UpdateProduct:output_type -> cerasus.BoolReply
