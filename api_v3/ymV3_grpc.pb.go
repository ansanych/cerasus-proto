...
func (c *yMClient) GetConnectedCompanies(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*CompanyList, error) {
	out := new(CompanyList)
...
func (c *yMClient) GetShopProducts(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*ShopProductList, error) {
	...
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/GetShopProducts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yMClient) GetProductsCount(ctx context.Context, in *Auth, opts ...grpc.CallOption) (*Count, error) {
	out := new(Count)
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/GetProductsCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yMClient) GetUnsortedList(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*ShopProductList, error) {
	out := new(ShopProductList)
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/GetUnsortedList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yMClient) GetSale(ctx context.Context, in *RequestByID, opts ...grpc.CallOption) (*Sale, error) {
	out := new(Sale)
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/GetSale", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yMClient) GetShopProductsDatas(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*ShopProductList, error) {
	out := new(ShopProductList)
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/GetShopProductsDatas", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yMClient) SendNewPrices(ctx context.Context, in *YMApiNewPricesRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/SendNewPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yMClient) GetShopPrices(ctx context.Context, in *ShopPriceRequest, opts ...grpc.CallOption) (*ShopPriceReply, error) {
	out := new(ShopPriceReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.YM/GetShopPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedYMServer) GetConnectedCompanies(context.Context, *RequestByIDS) (*CompanyList, error) {
...
func (UnimplementedYMServer) GetSale(context.Context, *RequestByID) (*Sale, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSale not implemented")
}
func (UnimplementedYMServer) GetShopProductsDatas(context.Context, *RequestByIDS) (*ShopProductList, error) {
...
func (UnimplementedYMServer) GetShopPrices(context.Context, *ShopPriceRequest) (*ShopPriceReply, error) {
...
func RegisterYMServer(s *grpc.Server, srv YMServer) {
	s.RegisterService(&_YM_serviceDesc, srv)
}
...
func _YM_GetConnectedCompanies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YMServer).GetConnectedCompanies(ctx, req.(*RequestByIDS))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _YM_GetShopProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/GetShopProducts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _YM_GetProductsCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/GetProductsCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _YM_GetUnsortedList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/GetUnsortedList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _YM_GetSale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/GetSale",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YMServer).GetSale(ctx, req.(*RequestByID))
	}
	return interceptor(ctx, in, info, handler)
}

func _YM_GetShopProductsDatas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestByIDS)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YMServer).GetShopProductsDatas(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/GetShopProductsDatas",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YMServer).GetShopProductsDatas(ctx, req.(*RequestByIDS))
	}
	return interceptor(ctx, in, info, handler)
}

func _YM_SendNewPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(YMApiNewPricesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YMServer).SendNewPrices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/SendNewPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YMServer).SendNewPrices(ctx, req.(*YMApiNewPricesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _YM_GetShopPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShopPriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YMServer).GetShopPrices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.YM/GetShopPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YMServer).GetShopPrices(ctx, req.(*ShopPriceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _YM_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _YM_GetShopProductsDatas_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _YM_GetShopPrices_Handler,
		},
	},
