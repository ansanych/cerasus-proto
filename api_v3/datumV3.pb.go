...
var file_datumV3_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xbe, 0x01,
	...
	0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3e,
	0x0a, 0x12, 0x47, 0x65, 0x74, 0x53, 0x68, 0x6f, 0x70, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x57, 0x69,
	0x64, 0x67, 0x65, 0x74, 0x12, 0x0f, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x33,
	0x2e, 0x41, 0x75, 0x74, 0x68, 0x1a, 0x15, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56,
	0x33, 0x2e, 0x53, 0x68, 0x6f, 0x70, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x22, 0x00, 0x42, 0x23,
...
var file_datumV3_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_datumV3_proto_goTypes = []interface{}{
	...
	(*QueuerJob)(nil),      // 3: cerasusV3.QueuerJob
...
var file_datumV3_proto_depIdxs = []int32{
	...
	2, // 1: cerasusV3.Datum.Ping:input_type -> cerasusV3.PingRequest
	3, // 2: cerasusV3.Datum.SetQueueJob:input_type -> cerasusV3.QueuerJob
	4, // 3: cerasusV3.Datum.GetShopSalesWidget:input_type -> cerasusV3.Auth
	5, // 4: cerasusV3.Datum.Ping:output_type -> cerasusV3.PingReply
	6, // 5: cerasusV3.Datum.SetQueueJob:output_type -> cerasusV3.StatusReply
	1, // 6: cerasusV3.Datum.GetShopSalesWidget:output_type -> cerasusV3.ShopWidget
