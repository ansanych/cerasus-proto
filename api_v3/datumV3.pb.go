...
var file_datumV3_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x65, 0x72, 0x52, 0x07, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x32, 0x9f, 0x03,
	...
	0x72, 0x61, 0x70, 0x68, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x57, 0x65, 0x65,
	...
	0x33, 0x2e, 0x57, 0x65, 0x65, 0x6b, 0x47, 0x72, 0x61, 0x70, 0x68, 0x69, 0x63, 0x22, 0x00, 0x42,
...
var file_datumV3_proto_goTypes = []interface{}{
	...
	(*WeekGraphic)(nil),      // 11: cerasusV3.WeekGraphic
}
var file_datumV3_proto_depIdxs = []int32{
	...
	7,  // 7: cerasusV3.Datum.GetWeekGraphic:input_type -> cerasusV3.LineGraphRequest
	8,  // 8: cerasusV3.Datum.Ping:output_type -> cerasusV3.PingReply
	9,  // 9: cerasusV3.Datum.SetQueueJob:output_type -> cerasusV3.StatusReply
	1,  // 10: cerasusV3.Datum.GetShopSalesWidget:output_type -> cerasusV3.ShopWidget
	3,  // 11: cerasusV3.Datum.GetOrderLeaders:output_type -> cerasusV3.OrderLeaders
	10, // 12: cerasusV3.Datum.GetMainGraphic:output_type -> cerasusV3.LineGraph
	11, // 13: cerasusV3.Datum.GetWeekGraphic:output_type -> cerasusV3.WeekGraphic
