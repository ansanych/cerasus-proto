...
func (c *wBClient) GetConnectedCompanies(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*CompanyList, error) {
	out := new(CompanyList)
...
func (c *wBClient) GetSale(ctx context.Context, in *RequestByID, opts ...grpc.CallOption) (*Sale, error) {
	out := new(Sale)
...
func (c *wBClient) GetShopProductsDatas(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*ShopProductList, error) {
	out := new(ShopProductList)
	err := c.cc.Invoke(ctx, "/cerasusV3.WB/GetShopProductsDatas", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wBClient) GetCompaniesData(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*CompaniesData, error) {
	out := new(CompaniesData)
	err := c.cc.Invoke(ctx, "/cerasusV3.WB/GetCompaniesData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wBClient) CompanyAuthActivate(ctx context.Context, in *RequestActivate, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.WB/CompanyAuthActivate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWBServer) GetConnectedCompanies(context.Context, *RequestByIDS) (*CompanyList, error) {
...
func (UnimplementedWBServer) GetSale(context.Context, *RequestByID) (*Sale, error) {
...
func (UnimplementedWBServer) GetCompaniesData(context.Context, *RequestByIDS) (*CompaniesData, error) {
...
func RegisterWBServer(s *grpc.Server, srv WBServer) {
	s.RegisterService(&_WB_serviceDesc, srv)
}
...
func _WB_GetConnectedCompanies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).GetConnectedCompanies(ctx, req.(*RequestByIDS))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WB_GetSale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).GetSale(ctx, req.(*RequestByID))
	}
	return interceptor(ctx, in, info, handler)
}

func _WB_GetShopProductsDatas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestByIDS)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WBServer).GetShopProductsDatas(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.WB/GetShopProductsDatas",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).GetShopProductsDatas(ctx, req.(*RequestByIDS))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WB_GetCompaniesData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestByIDS)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WBServer).GetCompaniesData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.WB/GetCompaniesData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).GetCompaniesData(ctx, req.(*RequestByIDS))
	}
	return interceptor(ctx, in, info, handler)
}

func _WB_CompanyAuthActivate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestActivate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WBServer).CompanyAuthActivate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.WB/CompanyAuthActivate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WBServer).CompanyAuthActivate(ctx, req.(*RequestActivate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WB_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WB_GetCompaniesData_Handler,
		},
		{
