...
func (c *connectorClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingReply, error) {
	out := new(PingReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.Connector/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorClient) SetClientAddress(ctx context.Context, in *Client, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.Connector/SetClientAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorClient) GetClientAddress(ctx context.Context, in *Client, opts ...grpc.CallOption) (*Client, error) {
	out := new(Client)
	err := c.cc.Invoke(ctx, "/cerasusV3.Connector/GetClientAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorClient) GetClientsList(ctx context.Context, in *Auth, opts ...grpc.CallOption) (*ClientsList, error) {
	out := new(ClientsList)
	err := c.cc.Invoke(ctx, "/cerasusV3.Connector/GetClientsList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Connector_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.Connector/Ping",
	}
...
func _Connector_SetClientAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.Connector/SetClientAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Connector_GetClientAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.Connector/GetClientAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Connector_GetClientsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.Connector/GetClientsList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Connector_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cerasusV3.Connector",
