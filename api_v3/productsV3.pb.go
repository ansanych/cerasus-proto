...
var file_productsV3_proto_rawDesc = []byte{
	...
	0x6e, 0x6b, 0x53, 0x68, 0x6f, 0x70, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xf7, 0x09, 0x0a,
...
var file_productsV3_proto_goTypes = []interface{}{
	...
	(*PingReply)(nil),                 // 22: cerasusV3.PingReply
	(*ProductList)(nil),               // 23: cerasusV3.ProductList
	(*Product)(nil),                   // 24: cerasusV3.Product
	(*StatusReply)(nil),               // 25: cerasusV3.StatusReply
	(*ShopProductList)(nil),           // 26: cerasusV3.ShopProductList
}
var file_productsV3_proto_depIdxs = []int32{
	...
	22, // 31: cerasusV3.Products.Ping:output_type -> cerasusV3.PingReply
	23, // 32: cerasusV3.Products.GetProductList:output_type -> cerasusV3.ProductList
	23, // 33: cerasusV3.Products.GetProductSearch:output_type -> cerasusV3.ProductList
	24, // 34: cerasusV3.Products.GetProduct:output_type -> cerasusV3.Product
	2,  // 35: cerasusV3.Products.GetShopProductsMatch:output_type -> cerasusV3.ShopProductsMatches
	4,  // 36: cerasusV3.Products.GetPurchases:output_type -> cerasusV3.ProductsPurchases
	6,  // 37: cerasusV3.Products.GetProductsUnsortedCount:output_type -> cerasusV3.UnsortedCount
	25, // 38: cerasusV3.Products.ConnectUnsorted:output_type -> cerasusV3.StatusReply
	25, // 39: cerasusV3.Products.UpdateProduct:output_type -> cerasusV3.StatusReply
	3,  // 40: cerasusV3.Products.GetProductPurchase:output_type -> cerasusV3.ProductPurchases
	25, // 41: cerasusV3.Products.SetProductPurchase:output_type -> cerasusV3.StatusReply
	25, // 42: cerasusV3.Products.DeleteProductPurchase:output_type -> cerasusV3.StatusReply
	25, // 43: cerasusV3.Products.SetProductBrand:output_type -> cerasusV3.StatusReply
	13, // 44: cerasusV3.Products.GetProductLinks:output_type -> cerasusV3.ProductLinks
	25, // 45: cerasusV3.Products.DeleteProductLink:output_type -> cerasusV3.StatusReply
	26, // 46: cerasusV3.Products.GetProductsUnsortedList:output_type -> cerasusV3.ShopProductList
	23, // 47: cerasusV3.Products.GetProductsByIDS:output_type -> cerasusV3.ProductList
