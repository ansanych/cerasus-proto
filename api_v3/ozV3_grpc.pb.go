...
func (c *oZClient) GetSale(ctx context.Context, in *RequestByID, opts ...grpc.CallOption) (*Sale, error) {
	out := new(Sale)
...
func (c *oZClient) GetShopProductsDatas(ctx context.Context, in *RequestByIDS, opts ...grpc.CallOption) (*ShopProductList, error) {
	out := new(ShopProductList)
	err := c.cc.Invoke(ctx, "/cerasusV3.OZ/GetShopProductsDatas", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oZClient) SendNewPrices(ctx context.Context, in *OZApiNewPricesRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.OZ/SendNewPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oZClient) GetShopPrices(ctx context.Context, in *ShopPriceRequest, opts ...grpc.CallOption) (*ShopPriceReply, error) {
	out := new(ShopPriceReply)
	err := c.cc.Invoke(ctx, "/cerasusV3.OZ/GetShopPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOZServer) GetSale(context.Context, *RequestByID) (*Sale, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSale not implemented")
}
func (UnimplementedOZServer) GetShopProductsDatas(context.Context, *RequestByIDS) (*ShopProductList, error) {
...
func (UnimplementedOZServer) GetShopPrices(context.Context, *ShopPriceRequest) (*ShopPriceReply, error) {
...
func RegisterOZServer(s *grpc.Server, srv OZServer) {
	s.RegisterService(&_OZ_serviceDesc, srv)
}
...
func _OZ_GetSale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OZServer).GetSale(ctx, req.(*RequestByID))
	}
	return interceptor(ctx, in, info, handler)
}

func _OZ_GetShopProductsDatas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestByIDS)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OZServer).GetShopProductsDatas(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.OZ/GetShopProductsDatas",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OZServer).GetShopProductsDatas(ctx, req.(*RequestByIDS))
	}
	return interceptor(ctx, in, info, handler)
}

func _OZ_SendNewPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OZApiNewPricesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OZServer).SendNewPrices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.OZ/SendNewPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OZServer).SendNewPrices(ctx, req.(*OZApiNewPricesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OZ_GetShopPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShopPriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OZServer).GetShopPrices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV3.OZ/GetShopPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OZServer).GetShopPrices(ctx, req.(*ShopPriceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _OZ_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OZ_GetShopProductsDatas_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _OZ_GetShopPrices_Handler,
		},
	},
