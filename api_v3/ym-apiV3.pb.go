...
var file_ym_apiV3_proto_rawDesc = []byte{
	...
	0x2d, 0x64, 0x61, 0x74, 0x61, 0x56, 0x33, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa6, 0x04,
	...
	0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x33, 0x2e, 0x59, 0x4d, 0x41, 0x75, 0x74, 0x68, 0x50,
	...
	0x73, 0x12, 0x17, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x33, 0x2e, 0x59, 0x4d,
	...
	0x75, 0x63, 0x74, 0x73, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_ym_apiV3_proto_goTypes = []interface{}{
	...
	(*YMAuthParams)(nil),     // 3: cerasusV3.YMAuthParams
	(*PingReply)(nil),        // 4: cerasusV3.PingReply
	(*YMParams)(nil),         // 5: cerasusV3.YMParams
...
var file_ym_apiV3_proto_depIdxs = []int32{
	...
	3, // 6: cerasusV3.YM_API.LoadApiProducts:input_type -> cerasusV3.YMAuthParams
	3, // 7: cerasusV3.YM_API.GetApiProducts:input_type -> cerasusV3.YMAuthParams
	4, // 8: cerasusV3.YM_API.Ping:output_type -> cerasusV3.PingReply
	5, // 9: cerasusV3.YM_API.GetCampaigns:output_type -> cerasusV3.YMParams
	6, // 10: cerasusV3.YM_API.LoadApiOrders:output_type -> cerasusV3.StatusReply
	7, // 11: cerasusV3.YM_API.GetApiOrders:output_type -> cerasusV3.YMApiOrders
	6, // 12: cerasusV3.YM_API.LoadApiSales:output_type -> cerasusV3.StatusReply
	8, // 13: cerasusV3.YM_API.GetApiSales:output_type -> cerasusV3.YMApiSales
	6, // 14: cerasusV3.YM_API.LoadApiProducts:output_type -> cerasusV3.StatusReply
	9, // 15: cerasusV3.YM_API.GetApiProducts:output_type -> cerasusV3.YMApiProducts
