...
var file_ym_apiV3_proto_rawDesc = []byte{
	...
	0x2d, 0x64, 0x61, 0x74, 0x61, 0x56, 0x33, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd0, 0x06,
	...
	0x12, 0x51, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x53,
	0x68, 0x6f, 0x70, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1c, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73,
	0x75, 0x73, 0x56, 0x33, 0x2e, 0x59, 0x4d, 0x41, 0x70, 0x69, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73,
	0x56, 0x33, 0x2e, 0x59, 0x4d, 0x41, 0x70, 0x69, 0x50, 0x72, 0x69, 0x63, 0x65, 0x44, 0x61, 0x74,
	0x61, 0x22, 0x00, 0x12, 0x4b, 0x0a, 0x0d, 0x53, 0x65, 0x6e, 0x64, 0x4e, 0x65, 0x77, 0x50, 0x72,
	...
	0x12, 0x4e, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x53, 0x68, 0x6f, 0x70, 0x50, 0x72, 0x69, 0x63, 0x65,
	0x73, 0x12, 0x20, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x33, 0x2e, 0x59, 0x4d,
	0x41, 0x70, 0x69, 0x53, 0x68, 0x6f, 0x70, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75,
...
var file_ym_apiV3_proto_goTypes = []interface{}{
	...
	(*YMApiPriceRequest)(nil),     // 4: cerasusV3.YMApiPriceRequest
	(*YMApiNewPricesRequest)(nil), // 5: cerasusV3.YMApiNewPricesRequest
	(*YMApiShopPriceRequest)(nil), // 6: cerasusV3.YMApiShopPriceRequest
	(*PingReply)(nil),             // 7: cerasusV3.PingReply
	(*StatusReply)(nil),           // 8: cerasusV3.StatusReply
	(*YMApiOrders)(nil),           // 9: cerasusV3.YMApiOrders
	(*YMApiSales)(nil),            // 10: cerasusV3.YMApiSales
	(*YMApiProducts)(nil),         // 11: cerasusV3.YMApiProducts
	(*YMApiStockData)(nil),        // 12: cerasusV3.YMApiStockData
	(*YMApiPriceData)(nil),        // 13: cerasusV3.YMApiPriceData
...
var file_ym_apiV3_proto_depIdxs = []int32{
	...
	4,  // 9: cerasusV3.YM_API.GetProductsShopPrice:input_type -> cerasusV3.YMApiPriceRequest
	5,  // 10: cerasusV3.YM_API.SendNewPrices:input_type -> cerasusV3.YMApiNewPricesRequest
	6,  // 11: cerasusV3.YM_API.GetShopPrices:input_type -> cerasusV3.YMApiShopPriceRequest
	7,  // 12: cerasusV3.YM_API.Ping:output_type -> cerasusV3.PingReply
	3,  // 13: cerasusV3.YM_API.GetCampaigns:output_type -> cerasusV3.YMParams
	8,  // 14: cerasusV3.YM_API.LoadApiOrders:output_type -> cerasusV3.StatusReply
	9,  // 15: cerasusV3.YM_API.GetApiOrders:output_type -> cerasusV3.YMApiOrders
	8,  // 16: cerasusV3.YM_API.LoadApiSales:output_type -> cerasusV3.StatusReply
	10, // 17: cerasusV3.YM_API.GetApiSales:output_type -> cerasusV3.YMApiSales
	8,  // 18: cerasusV3.YM_API.LoadApiProducts:output_type -> cerasusV3.StatusReply
	11, // 19: cerasusV3.YM_API.GetApiProducts:output_type -> cerasusV3.YMApiProducts
	12, // 20: cerasusV3.YM_API.GetApiStocks:output_type -> cerasusV3.YMApiStockData
	13, // 21: cerasusV3.YM_API.GetProductsShopPrice:output_type -> cerasusV3.YMApiPriceData
	8,  // 22: cerasusV3.YM_API.SendNewPrices:output_type -> cerasusV3.StatusReply
	14, // 23: cerasusV3.YM_API.GetShopPrices:output_type -> cerasusV3.ShopPriceReply
