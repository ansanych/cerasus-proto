...
var file_queuerV3_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x32, 0xcd,
	...
	0x79, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x51, 0x75,
	0x65, 0x75, 0x65, 0x73, 0x12, 0x1f, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x33,
	0x2e, 0x52, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x51, 0x75, 0x65, 0x75, 0x65, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56,
	0x33, 0x2e, 0x51, 0x75, 0x65, 0x75, 0x65, 0x72, 0x4a, 0x6f, 0x62, 0x73, 0x22, 0x00, 0x42, 0x23,
...
var file_queuerV3_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuerV3_proto_goTypes = []interface{}{
	(*RestartQueuesRequest)(nil), // 0: cerasusV3.RestartQueuesRequest
	(*PingRequest)(nil),          // 1: cerasusV3.PingRequest
	(*QueuerJob)(nil),            // 2: cerasusV3.QueuerJob
	(*PingReply)(nil),            // 3: cerasusV3.PingReply
	(*StatusReply)(nil),          // 4: cerasusV3.StatusReply
	(*QueuerJobs)(nil),           // 5: cerasusV3.QueuerJobs
}
var file_queuerV3_proto_depIdxs = []int32{
	1, // 0: cerasusV3.Queuer.Ping:input_type -> cerasusV3.PingRequest
	2, // 1: cerasusV3.Queuer.ReportQueueJob:input_type -> cerasusV3.QueuerJob
	0, // 2: cerasusV3.Queuer.RestartQueues:input_type -> cerasusV3.RestartQueuesRequest
	3, // 3: cerasusV3.Queuer.Ping:output_type -> cerasusV3.PingReply
	4, // 4: cerasusV3.Queuer.ReportQueueJob:output_type -> cerasusV3.StatusReply
	5, // 5: cerasusV3.Queuer.RestartQueues:output_type -> cerasusV3.QueuerJobs
