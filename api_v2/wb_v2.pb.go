...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x32, 0xfc, 0x0b, 0x0a, 0x02, 0x57, 0x42, 0x12, 0x36, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12,
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x00, 0x42,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	10, // 24: cerasusV2.WB.Ping:output_type -> cerasusV2.PingReply
	11, // 25: cerasusV2.WB.GetAppData:output_type -> cerasusV2.AppShopData
	12, // 26: cerasusV2.WB.GetShopData:output_type -> cerasusV2.ShopData
	13, // 27: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	14, // 28: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	15, // 29: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
	15, // 30: cerasusV2.WB.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	15, // 31: cerasusV2.WB.GetFlowGraphicData:output_type -> cerasusV2.Count
	15, // 32: cerasusV2.WB.GetMarginGraphicData:output_type -> cerasusV2.Count
	16, // 33: cerasusV2.WB.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	17, // 34: cerasusV2.WB.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	17, // 35: cerasusV2.WB.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	18, // 36: cerasusV2.WB.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	19, // 37: cerasusV2.WB.GetShopProducts:output_type -> cerasusV2.ShopProductList
	1,  // 38: cerasusV2.WB.GetShopProduct:output_type -> cerasusV2.ShopProduct
	20, // 39: cerasusV2.WB.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	21, // 40: cerasusV2.WB.GetSales:output_type -> cerasusV2.Sales
	22, // 41: cerasusV2.WB.GetProductWidget:output_type -> cerasusV2.ProductWidgets
	22, // 42: cerasusV2.WB.GetProductWidgetOrders:output_type -> cerasusV2.ProductWidgets
	23, // 43: cerasusV2.WB.GetSale:output_type -> cerasusV2.Sale
	19, // 44: cerasusV2.WB.GetProductsUnsortedList:output_type -> cerasusV2.ShopProductList
	24, // 45: cerasusV2.WB.SetShopProductUrl:output_type -> cerasusV2.StatusReply
	0,  // 46: cerasusV2.WB.GetCounterParams:output_type -> cerasusV2.WBCounterParams
