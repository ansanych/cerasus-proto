...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xcd, 0x0f, 0x0a,
	...
	0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x53, 0x68, 0x6f, 0x70, 0x50,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	12, // 30: cerasusV2.WB.Ping:output_type -> cerasusV2.PingReply
	13, // 31: cerasusV2.WB.GetAppData:output_type -> cerasusV2.AppShopData
	14, // 32: cerasusV2.WB.SetAuthData:output_type -> cerasusV2.StatusReply
	2,  // 33: cerasusV2.WB.GetAuthData:output_type -> cerasusV2.WBAuthParams
	14, // 34: cerasusV2.WB.ResetAuthData:output_type -> cerasusV2.StatusReply
	15, // 35: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
	16, // 36: cerasusV2.WB.GetShopData:output_type -> cerasusV2.ShopData
	17, // 37: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	18, // 38: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	15, // 39: cerasusV2.WB.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	15, // 40: cerasusV2.WB.GetFlowGraphicData:output_type -> cerasusV2.Count
	15, // 41: cerasusV2.WB.GetMarginGraphicData:output_type -> cerasusV2.Count
	19, // 42: cerasusV2.WB.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	20, // 43: cerasusV2.WB.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	20, // 44: cerasusV2.WB.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	21, // 45: cerasusV2.WB.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	22, // 46: cerasusV2.WB.GetShopProducts:output_type -> cerasusV2.ShopProductList
	23, // 47: cerasusV2.WB.GetShopProduct:output_type -> cerasusV2.ShopProduct
	24, // 48: cerasusV2.WB.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	25, // 49: cerasusV2.WB.GetSales:output_type -> cerasusV2.Sales
	26, // 50: cerasusV2.WB.GetProductWidget:output_type -> cerasusV2.ProductWidgets
	26, // 51: cerasusV2.WB.GetProductWidgetOrders:output_type -> cerasusV2.ProductWidgets
	27, // 52: cerasusV2.WB.GetSale:output_type -> cerasusV2.Sale
	22, // 53: cerasusV2.WB.GetProductsUnsortedList:output_type -> cerasusV2.ShopProductList
	14, // 54: cerasusV2.WB.SetShopProductUrl:output_type -> cerasusV2.StatusReply
	28, // 55: cerasusV2.WB.GetCounterParams:output_type -> cerasusV2.WBCounterParams
	29, // 56: cerasusV2.WB.GetImage:output_type -> cerasusV2.ImageReply
	23, // 57: cerasusV2.WB.GetShopProductByCode:output_type -> cerasusV2.ShopProduct
	30, // 58: cerasusV2.WB.GetOrdersForBrand:output_type -> cerasusV2.Orders
	22, // 59: cerasusV2.WB.GetUnsortedList:output_type -> cerasusV2.ShopProductList
