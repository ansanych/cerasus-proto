...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xfc, 0x06, 0x0a, 0x02, 0x57,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	4,  // 13: cerasusV2.WB.GetSales:input_type -> cerasusV2.RequestByDates
	5,  // 14: cerasusV2.WB.Ping:output_type -> cerasusV2.PingReply
	6,  // 15: cerasusV2.WB.GetAppData:output_type -> cerasusV2.AppShopData
	7,  // 16: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	8,  // 17: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	9,  // 18: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
	9,  // 19: cerasusV2.WB.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	9,  // 20: cerasusV2.WB.GetFlowGraphicData:output_type -> cerasusV2.Count
	9,  // 21: cerasusV2.WB.GetMarginGraphicData:output_type -> cerasusV2.Count
	10, // 22: cerasusV2.WB.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	11, // 23: cerasusV2.WB.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	11, // 24: cerasusV2.WB.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 25: cerasusV2.WB.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	13, // 26: cerasusV2.WB.GetShopProducts:output_type -> cerasusV2.ShopProductList
	14, // 27: cerasusV2.WB.GetSales:output_type -> cerasusV2.Sales
