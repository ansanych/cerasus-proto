...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb0, 0x02, 0x0a, 0x02, 0x57,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	3, // 5: cerasusV2.WB.Ping:output_type -> cerasusV2.PingReply
	4, // 6: cerasusV2.WB.GetAppData:output_type -> cerasusV2.AppShopData
	5, // 7: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	6, // 8: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	7, // 9: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
