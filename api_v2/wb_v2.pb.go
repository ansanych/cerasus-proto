...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb6, 0x05, 0x0a, 0x02, 0x57,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	1,  // 5: cerasusV2.WB.GetFlowGraphicData:input_type -> cerasusV2.Auth
	1,  // 6: cerasusV2.WB.GetMarginGraphicData:input_type -> cerasusV2.Auth
	2,  // 7: cerasusV2.WB.GetWeekGraphic:input_type -> cerasusV2.LineGraphRequest
	1,  // 8: cerasusV2.WB.GetPayRoundGraphic:input_type -> cerasusV2.Auth
	1,  // 9: cerasusV2.WB.GetCountRoundGraphic:input_type -> cerasusV2.Auth
	1,  // 10: cerasusV2.WB.GetOrderLeaders:input_type -> cerasusV2.Auth
	3,  // 11: cerasusV2.WB.Ping:output_type -> cerasusV2.PingReply
	4,  // 12: cerasusV2.WB.GetAppData:output_type -> cerasusV2.AppShopData
	5,  // 13: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	6,  // 14: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	7,  // 15: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
	7,  // 16: cerasusV2.WB.GetFlowGraphicData:output_type -> cerasusV2.Count
	7,  // 17: cerasusV2.WB.GetMarginGraphicData:output_type -> cerasusV2.Count
	8,  // 18: cerasusV2.WB.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	9,  // 19: cerasusV2.WB.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	9,  // 20: cerasusV2.WB.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	10, // 21: cerasusV2.WB.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
