...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x83, 0x0f, 0x0a,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	2,  // 32: cerasusV2.WB.GetAuthData:output_type -> cerasusV2.WBAuthParams
	14, // 33: cerasusV2.WB.ResetAuthData:output_type -> cerasusV2.StatusReply
	15, // 34: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
	16, // 35: cerasusV2.WB.GetShopData:output_type -> cerasusV2.ShopData
	17, // 36: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	18, // 37: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	15, // 38: cerasusV2.WB.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	15, // 39: cerasusV2.WB.GetFlowGraphicData:output_type -> cerasusV2.Count
	15, // 40: cerasusV2.WB.GetMarginGraphicData:output_type -> cerasusV2.Count
