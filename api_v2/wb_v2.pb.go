...
var file_wb_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf7, 0x05, 0x0a, 0x02, 0x57,
...
var file_wb_v2_proto_depIdxs = []int32{
	...
	3,  // 12: cerasusV2.WB.Ping:output_type -> cerasusV2.PingReply
	4,  // 13: cerasusV2.WB.GetAppData:output_type -> cerasusV2.AppShopData
	5,  // 14: cerasusV2.WB.GetShopWidget:output_type -> cerasusV2.ShopWidget
	6,  // 15: cerasusV2.WB.GetMainGraphic:output_type -> cerasusV2.LineGraph
	7,  // 16: cerasusV2.WB.GetProductsCount:output_type -> cerasusV2.Count
	7,  // 17: cerasusV2.WB.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	7,  // 18: cerasusV2.WB.GetFlowGraphicData:output_type -> cerasusV2.Count
	7,  // 19: cerasusV2.WB.GetMarginGraphicData:output_type -> cerasusV2.Count
	8,  // 20: cerasusV2.WB.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	9,  // 21: cerasusV2.WB.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	9,  // 22: cerasusV2.WB.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	10, // 23: cerasusV2.WB.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
