...
func (x *DetectedPrice) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DetectedPrice) ProtoMessage() {}

func (x *DetectedPrice) ProtoReflect() protoreflect.Message {
	mi := &file_cerasus_v2_proto_msgTypes[61]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DetectedPrice.ProtoReflect.Descriptor instead.
func (*DetectedPrice) Descriptor() ([]byte, []int) {
	return file_cerasus_v2_proto_rawDescGZIP(), []int{61}
}

func (x *DetectedPrice) GetJobID() int64 {
	if x != nil {
		return x.JobID
	}
	return 0
...
func (x *DetectedPrice) GetPrice() int32 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_cerasus_v2_proto_rawDesc = []byte{
	...
	0x22, 0x3b, 0x0a, 0x0d, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x65, 0x64, 0x50, 0x72, 0x69, 0x63,
	0x65, 0x12, 0x14, 0x0a, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x44, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x2a, 0x3d, 0x0a,
	...
	0x03, 0x12, 0x09, 0x0a, 0x05, 0x46, 0x41, 0x4c, 0x53, 0x45, 0x10, 0x04, 0x2a, 0x33, 0x0a, 0x0d,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0c, 0x0a,
	0x08, 0x44, 0x49, 0x53, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x45,
	0x4e, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x42, 0x49, 0x44, 0x10,
	0x02, 0x2a, 0x1e, 0x0a, 0x09, 0x53, 0x6f, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x07,
	0x0a, 0x03, 0x41, 0x53, 0x43, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x45, 0x53, 0x43, 0x10,
	0x01, 0x2a, 0x4f, 0x0a, 0x05, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x0b, 0x0a, 0x07, 0x4e, 0x4f,
...
var file_cerasus_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_cerasus_v2_proto_goTypes = []interface{}{
	...
	(*DetectedPrice)(nil),        // 65: cerasusV2.DetectedPrice
}
