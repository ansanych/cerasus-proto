...
type LineGraph struct {
	...
	Shops    []*LineGraphShop    `protobuf:"bytes,5,rep,name=shops,proto3" json:"shops,omitempty"`
}
...
func (x *LineGraph) GetMin() float32 {
	if x != nil {
		return x.Min
	}
	return 0
...
func (x *LineGraph) GetMax() float32 {
	if x != nil {
		return x.Max
	}
	return 0
...
type LineGraphRequest struct {
	...
	PeriodStep string `protobuf:"bytes,3,opt,name=periodStep,proto3" json:"periodStep,omitempty"`
...
func (x *LineGraphRequest) GetPeriodStep() string {
	if x != nil {
		return x.PeriodStep
	}
	return ""
...
func (x *LineGraphRequest) GetOffset() string {
	if x != nil {
		return x.Offset
	}
	return ""
...
var file_cerasus_v2_proto_rawDesc = []byte{
	...
	0x61, 0x22, 0x3a, 0x0a, 0x10, 0x4c, 0x69, 0x6e, 0x65, 0x47, 0x72, 0x61, 0x70, 0x68, 0x44, 0x61,
	...
	0x61, 0x18, 0x02, 0x20, 0x03, 0x28, 0x02, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x39, 0x0a,
	...
	0x05, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xb0, 0x01, 0x0a, 0x09, 0x4c, 0x69, 0x6e,
	...
	0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x69, 0x6e, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x6d, 0x69, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x61, 0x78,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x6d, 0x61, 0x78, 0x12, 0x2e, 0x0a, 0x05, 0x73,
	0x68, 0x6f, 0x70, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x65, 0x72,
	0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x4c, 0x69, 0x6e, 0x65, 0x47, 0x72, 0x61, 0x70, 0x68,
	0x53, 0x68, 0x6f, 0x70, 0x52, 0x05, 0x73, 0x68, 0x6f, 0x70, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x10,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x65, 0x72,
	0x69, 0x6f, 0x64, 0x53, 0x74, 0x65, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70,
	0x65, 0x72, 0x69, 0x6f, 0x64, 0x53, 0x74, 0x65, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66,
	0x73, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65,
	0x74, 0x2a, 0x28, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x55,
...
var file_cerasus_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_cerasus_v2_proto_goTypes = []interface{}{
	...
	(*LineGraphDataset)(nil), // 13: cerasusV2.LineGraphDataset
	(*LineGraphShop)(nil),    // 14: cerasusV2.LineGraphShop
	(*LineGraph)(nil),        // 15: cerasusV2.LineGraph
	(*LineGraphRequest)(nil), // 16: cerasusV2.LineGraphRequest
}
var file_cerasus_v2_proto_depIdxs = []int32{
	...
	13, // 6: cerasusV2.LineGraph.datasets:type_name -> cerasusV2.LineGraphDataset
	14, // 7: cerasusV2.LineGraph.shops:type_name -> cerasusV2.LineGraphShop
	5,  // 8: cerasusV2.LineGraphRequest.auth:type_name -> cerasusV2.Auth
