...
var file_ym_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x93, 0x08, 0x0a, 0x02, 0x59,
...
var file_ym_v2_proto_depIdxs = []int32{
	...
	5,  // 16: cerasusV2.YM.Ping:output_type -> cerasusV2.PingReply
	6,  // 17: cerasusV2.YM.GetAppData:output_type -> cerasusV2.AppShopData
	7,  // 18: cerasusV2.YM.GetShopWidget:output_type -> cerasusV2.ShopWidget
	8,  // 19: cerasusV2.YM.GetMainGraphic:output_type -> cerasusV2.LineGraph
	9,  // 20: cerasusV2.YM.GetProductsCount:output_type -> cerasusV2.Count
	9,  // 21: cerasusV2.YM.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	9,  // 22: cerasusV2.YM.GetFlowGraphicData:output_type -> cerasusV2.Count
	9,  // 23: cerasusV2.YM.GetMarginGraphicData:output_type -> cerasusV2.Count
	10, // 24: cerasusV2.YM.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	11, // 25: cerasusV2.YM.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	11, // 26: cerasusV2.YM.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 27: cerasusV2.YM.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	13, // 28: cerasusV2.YM.GetShopProducts:output_type -> cerasusV2.ShopProductList
	14, // 29: cerasusV2.YM.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	15, // 30: cerasusV2.YM.GetSales:output_type -> cerasusV2.Sales
	16, // 31: cerasusV2.YM.GetProductWidget:output_type -> cerasusV2.ProductWidget
