...
var file_ym_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xfc, 0x06, 0x0a, 0x02, 0x59,
	...
	0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x39,
	...
	0x32, 0x2e, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74,
...
var file_ym_v2_proto_depIdxs = []int32{
	...
	4,  // 13: cerasusV2.YM.GetSales:input_type -> cerasusV2.RequestByDates
	5,  // 14: cerasusV2.YM.Ping:output_type -> cerasusV2.PingReply
	6,  // 15: cerasusV2.YM.GetAppData:output_type -> cerasusV2.AppShopData
	7,  // 16: cerasusV2.YM.GetShopWidget:output_type -> cerasusV2.ShopWidget
	8,  // 17: cerasusV2.YM.GetMainGraphic:output_type -> cerasusV2.LineGraph
	9,  // 18: cerasusV2.YM.GetProductsCount:output_type -> cerasusV2.Count
	9,  // 19: cerasusV2.YM.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	9,  // 20: cerasusV2.YM.GetFlowGraphicData:output_type -> cerasusV2.Count
	9,  // 21: cerasusV2.YM.GetMarginGraphicData:output_type -> cerasusV2.Count
	10, // 22: cerasusV2.YM.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	11, // 23: cerasusV2.YM.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	11, // 24: cerasusV2.YM.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 25: cerasusV2.YM.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	13, // 26: cerasusV2.YM.GetShopProducts:output_type -> cerasusV2.ShopProductList
	14, // 27: cerasusV2.YM.GetSales:output_type -> cerasusV2.Sales
