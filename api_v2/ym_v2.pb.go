...
var file_ym_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc8, 0x07, 0x0a, 0x02, 0x59,
	...
	0x6c, 0x65, 0x73, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_ym_v2_proto_depIdxs = []int32{
	...
	5,  // 15: cerasusV2.YM.Ping:output_type -> cerasusV2.PingReply
	6,  // 16: cerasusV2.YM.GetAppData:output_type -> cerasusV2.AppShopData
	7,  // 17: cerasusV2.YM.GetShopWidget:output_type -> cerasusV2.ShopWidget
	8,  // 18: cerasusV2.YM.GetMainGraphic:output_type -> cerasusV2.LineGraph
	9,  // 19: cerasusV2.YM.GetProductsCount:output_type -> cerasusV2.Count
	9,  // 20: cerasusV2.YM.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	9,  // 21: cerasusV2.YM.GetFlowGraphicData:output_type -> cerasusV2.Count
	9,  // 22: cerasusV2.YM.GetMarginGraphicData:output_type -> cerasusV2.Count
	10, // 23: cerasusV2.YM.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	11, // 24: cerasusV2.YM.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	11, // 25: cerasusV2.YM.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 26: cerasusV2.YM.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	13, // 27: cerasusV2.YM.GetShopProducts:output_type -> cerasusV2.ShopProductList
	14, // 28: cerasusV2.YM.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	15, // 29: cerasusV2.YM.GetSales:output_type -> cerasusV2.Sales
