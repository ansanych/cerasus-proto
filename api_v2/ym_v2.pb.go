...
var file_ym_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf1, 0x03, 0x0a, 0x02, 0x59,
	...
	0x2e, 0x57, 0x65, 0x65, 0x6b, 0x47, 0x72, 0x61, 0x70, 0x68, 0x69, 0x63, 0x22, 0x00, 0x42, 0x23,
...
var file_ym_v2_proto_depIdxs = []int32{
	...
	3, // 8: cerasusV2.YM.Ping:output_type -> cerasusV2.PingReply
	4, // 9: cerasusV2.YM.GetAppData:output_type -> cerasusV2.AppShopData
	5, // 10: cerasusV2.YM.GetShopWidget:output_type -> cerasusV2.ShopWidget
	6, // 11: cerasusV2.YM.GetMainGraphic:output_type -> cerasusV2.LineGraph
	7, // 12: cerasusV2.YM.GetProductsCount:output_type -> cerasusV2.Count
	7, // 13: cerasusV2.YM.GetFlowGraphicData:output_type -> cerasusV2.Count
	7, // 14: cerasusV2.YM.GetMarginGraphicData:output_type -> cerasusV2.Count
	8, // 15: cerasusV2.YM.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
