...
var file_ym_v2_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x63, 0x74, 0x73, 0x22, 0x67, 0x0a, 0x0a, 0x59, 0x4d, 0x41, 0x75, 0x74, 0x68, 0x44,
	...
	0x69, 0x6e, 0x65, 0x73, 0x73, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x62,
	0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x49, 0x44, 0x12, 0x23, 0x0a, 0x04, 0x61, 0x75, 0x74,
	0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75,
	0x73, 0x56, 0x32, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x32, 0x8a,
...
var file_ym_v2_proto_goTypes = []interface{}{
	...
	(*YMAuthData)(nil),           // 1: cerasusV2.YMAuthData
	(*YMCampaign)(nil),           // 2: cerasusV2.YMCampaign
...
var file_ym_v2_proto_depIdxs = []int32{
	2,  // 0: cerasusV2.YMCounterParams.campaigns:type_name -> cerasusV2.YMCampaign
	3,  // 1: cerasusV2.YMCounterParams.shopProducts:type_name -> cerasusV2.ShopProduct
	4,  // 2: cerasusV2.YMAuthData.auth:type_name -> cerasusV2.Auth
	5,  // 3: cerasusV2.YM.Ping:input_type -> cerasusV2.PingRequest
	4,  // 4: cerasusV2.YM.GetAppData:input_type -> cerasusV2.Auth
	4,  // 5: cerasusV2.YM.GetShopData:input_type -> cerasusV2.Auth
	4,  // 6: cerasusV2.YM.GetShopWidget:input_type -> cerasusV2.Auth
	6,  // 7: cerasusV2.YM.GetMainGraphic:input_type -> cerasusV2.LineGraphRequest
	4,  // 8: cerasusV2.YM.GetProductsCount:input_type -> cerasusV2.Auth
	4,  // 9: cerasusV2.YM.GetProductsCountUnsorted:input_type -> cerasusV2.Auth
	4,  // 10: cerasusV2.YM.GetFlowGraphicData:input_type -> cerasusV2.Auth
	4,  // 11: cerasusV2.YM.GetMarginGraphicData:input_type -> cerasusV2.Auth
	6,  // 12: cerasusV2.YM.GetWeekGraphic:input_type -> cerasusV2.LineGraphRequest
	4,  // 13: cerasusV2.YM.GetPayRoundGraphic:input_type -> cerasusV2.Auth
	4,  // 14: cerasusV2.YM.GetCountRoundGraphic:input_type -> cerasusV2.Auth
	4,  // 15: cerasusV2.YM.GetOrderLeaders:input_type -> cerasusV2.Auth
	...
	4,  // 23: cerasusV2.YM.GetProductsUnsortedList:input_type -> cerasusV2.Auth
	...
	1,  // 29: cerasusV2.YM.SetAuthData:input_type -> cerasusV2.YMAuthData
	...
	3,  // 44: cerasusV2.YM.GetShopProduct:output_type -> cerasusV2.ShopProduct
	...
	0,  // 52: cerasusV2.YM.GetCounterParams:output_type -> cerasusV2.YMCounterParams
	30, // 53: cerasusV2.YM.GetImage:output_type -> cerasusV2.ImageReply
	3,  // 54: cerasusV2.YM.GetShopProductByCode:output_type -> cerasusV2.ShopProduct
