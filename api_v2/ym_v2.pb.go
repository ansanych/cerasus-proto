...
var file_ym_v2_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9c, 0x09, 0x0a, 0x02, 0x59,
	...
	0x6c, 0x65, 0x73, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64,
	...
	0x73, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x53, 0x61, 0x6c, 0x65, 0x12, 0x16,
	...
	0x56, 0x32, 0x2e, 0x53, 0x61, 0x6c, 0x65, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74,
...
var file_ym_v2_proto_goTypes = []interface{}{
	...
	(*ShopWidget)(nil),       // 8: cerasusV2.ShopWidget
	(*LineGraph)(nil),        // 9: cerasusV2.LineGraph
	(*Count)(nil),            // 10: cerasusV2.Count
	(*WeekGraphic)(nil),      // 11: cerasusV2.WeekGraphic
	(*RoundGraphic)(nil),     // 12: cerasusV2.RoundGraphic
	(*OrderLeaders)(nil),     // 13: cerasusV2.OrderLeaders
	(*ShopProductList)(nil),  // 14: cerasusV2.ShopProductList
	(*LineGraphics)(nil),     // 15: cerasusV2.LineGraphics
	(*Sales)(nil),            // 16: cerasusV2.Sales
	(*ProductWidgets)(nil),   // 17: cerasusV2.ProductWidgets
	(*Sale)(nil),             // 18: cerasusV2.Sale
}
var file_ym_v2_proto_depIdxs = []int32{
	...
	1,  // 5: cerasusV2.YM.GetProductsCountUnsorted:input_type -> cerasusV2.Auth
	1,  // 6: cerasusV2.YM.GetFlowGraphicData:input_type -> cerasusV2.Auth
	1,  // 7: cerasusV2.YM.GetMarginGraphicData:input_type -> cerasusV2.Auth
	2,  // 8: cerasusV2.YM.GetWeekGraphic:input_type -> cerasusV2.LineGraphRequest
	1,  // 9: cerasusV2.YM.GetPayRoundGraphic:input_type -> cerasusV2.Auth
	1,  // 10: cerasusV2.YM.GetCountRoundGraphic:input_type -> cerasusV2.Auth
	1,  // 11: cerasusV2.YM.GetOrderLeaders:input_type -> cerasusV2.Auth
	3,  // 12: cerasusV2.YM.GetShopProducts:input_type -> cerasusV2.RequestByIDs
	4,  // 13: cerasusV2.YM.GetProductGraphics:input_type -> cerasusV2.RequestByDates
	4,  // 14: cerasusV2.YM.GetSales:input_type -> cerasusV2.RequestByDates
	4,  // 15: cerasusV2.YM.GetProductWidget:input_type -> cerasusV2.RequestByDates
	4,  // 16: cerasusV2.YM.GetProductWidgetOrders:input_type -> cerasusV2.RequestByDates
	5,  // 17: cerasusV2.YM.GetSale:input_type -> cerasusV2.SaleRequest
	6,  // 18: cerasusV2.YM.Ping:output_type -> cerasusV2.PingReply
	7,  // 19: cerasusV2.YM.GetAppData:output_type -> cerasusV2.AppShopData
	8,  // 20: cerasusV2.YM.GetShopWidget:output_type -> cerasusV2.ShopWidget
	9,  // 21: cerasusV2.YM.GetMainGraphic:output_type -> cerasusV2.LineGraph
	10, // 22: cerasusV2.YM.GetProductsCount:output_type -> cerasusV2.Count
	10, // 23: cerasusV2.YM.GetProductsCountUnsorted:output_type -> cerasusV2.Count
	10, // 24: cerasusV2.YM.GetFlowGraphicData:output_type -> cerasusV2.Count
	10, // 25: cerasusV2.YM.GetMarginGraphicData:output_type -> cerasusV2.Count
	11, // 26: cerasusV2.YM.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	12, // 27: cerasusV2.YM.GetPayRoundGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 28: cerasusV2.YM.GetCountRoundGraphic:output_type -> cerasusV2.RoundGraphic
	13, // 29: cerasusV2.YM.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	14, // 30: cerasusV2.YM.GetShopProducts:output_type -> cerasusV2.ShopProductList
	15, // 31: cerasusV2.YM.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	16, // 32: cerasusV2.YM.GetSales:output_type -> cerasusV2.Sales
	17, // 33: cerasusV2.YM.GetProductWidget:output_type -> cerasusV2.ProductWidgets
	17, // 34: cerasusV2.YM.GetProductWidgetOrders:output_type -> cerasusV2.ProductWidgets
	18, // 35: cerasusV2.YM.GetSale:output_type -> cerasusV2.Sale
