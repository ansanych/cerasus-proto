...
type AuthentyClient interface {
	...
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*StatusReply, error)
	Refresh(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*StatusReply, error)
...
func (c *authentyClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasus_2.Authenty/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authentyClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasus_2.Authenty/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authentyClient) Refresh(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/cerasus_2.Authenty/Refresh", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authentyClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingReply, error) {
	out := new(PingReply)
	err := c.cc.Invoke(ctx, "/cerasus_2.Authenty/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthentyServer interface {
	...
	Login(context.Context, *LoginRequest) (*StatusReply, error)
	Refresh(context.Context, *RefreshRequest) (*StatusReply, error)
...
func (UnimplementedAuthentyServer) Login(context.Context, *LoginRequest) (*StatusReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedAuthentyServer) Refresh(context.Context, *RefreshRequest) (*StatusReply, error) {
...
func _Authenty_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus_2.Authenty/Register",
	}
...
func _Authenty_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus_2.Authenty/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Authenty_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus_2.Authenty/Refresh",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Authenty_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasus_2.Authenty/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Authenty_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cerasus_2.Authenty",
