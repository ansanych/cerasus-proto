...
var file_settings_v2_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xe0, 0x0b, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x36,
	...
	0x79, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x42,
	0x79, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x12, 0x16, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73,
	...
	0x6e, 0x64, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_settings_v2_proto_depIdxs = []int32{
	...
	22, // 39: cerasusV2.Settings.GetBrandByCompany:input_type -> cerasusV2.RequestByID
	25, // 40: cerasusV2.Settings.Ping:output_type -> cerasusV2.PingReply
	1,  // 41: cerasusV2.Settings.GetUserAppData:output_type -> cerasusV2.UserAppData
	26, // 42: cerasusV2.Settings.GetMainGraphic:output_type -> cerasusV2.LineGraph
	27, // 43: cerasusV2.Settings.GetFlowGraphic:output_type -> cerasusV2.RoundGraphic
	27, // 44: cerasusV2.Settings.GetMarginGraphic:output_type -> cerasusV2.RoundGraphic
	28, // 45: cerasusV2.Settings.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	29, // 46: cerasusV2.Settings.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	30, // 47: cerasusV2.Settings.GetCompanyBrands:output_type -> cerasusV2.Brands
	17, // 48: cerasusV2.Settings.GetBrand:output_type -> cerasusV2.Brand
	31, // 49: cerasusV2.Settings.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	32, // 50: cerasusV2.Settings.GetTaxes:output_type -> cerasusV2.Taxes
	4,  // 51: cerasusV2.Settings.GetMarginLevels:output_type -> cerasusV2.MarginLevels
	33, // 52: cerasusV2.Settings.GetProductWidget:output_type -> cerasusV2.ProductWidgets
	33, // 53: cerasusV2.Settings.GetProductWidgetOrders:output_type -> cerasusV2.ProductWidgets
	34, // 54: cerasusV2.Settings.SetGeoPlace:output_type -> cerasusV2.StatusReply
	7,  // 55: cerasusV2.Settings.GetCompanyShops:output_type -> cerasusV2.CompanyShops
	10, // 56: cerasusV2.Settings.GetMargin:output_type -> cerasusV2.MarginSettings
	34, // 57: cerasusV2.Settings.SetMargin:output_type -> cerasusV2.StatusReply
	34, // 58: cerasusV2.Settings.DeleteMargin:output_type -> cerasusV2.StatusReply
	35, // 59: cerasusV2.Settings.GetAppTaxes:output_type -> cerasusV2.AppTaxes
	34, // 60: cerasusV2.Settings.SetTax:output_type -> cerasusV2.StatusReply
	36, // 61: cerasusV2.Settings.GetImage:output_type -> cerasusV2.ImageReply
	17, // 62: cerasusV2.Settings.GetBrandByCompany:output_type -> cerasusV2.Brand
