...
var file_settings_v2_proto_rawDesc = []byte{
	...
	0x32, 0x9e, 0x08, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x36, 0x0a,
	...
	0x79, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e,
	0x79, 0x53, 0x68, 0x6f, 0x70, 0x73, 0x12, 0x0f, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73,
...
var file_settings_v2_proto_depIdxs = []int32{
	...
	12, // 24: cerasusV2.Settings.GetCompanyShops:input_type -> cerasusV2.Auth
	16, // 25: cerasusV2.Settings.Ping:output_type -> cerasusV2.PingReply
	1,  // 26: cerasusV2.Settings.GetUserAppData:output_type -> cerasusV2.UserAppData
	17, // 27: cerasusV2.Settings.GetMainGraphic:output_type -> cerasusV2.LineGraph
	18, // 28: cerasusV2.Settings.GetFlowGraphic:output_type -> cerasusV2.RoundGraphic
	18, // 29: cerasusV2.Settings.GetMarginGraphic:output_type -> cerasusV2.RoundGraphic
	19, // 30: cerasusV2.Settings.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	20, // 31: cerasusV2.Settings.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	21, // 32: cerasusV2.Settings.GetCompanyBrands:output_type -> cerasusV2.Brands
	9,  // 33: cerasusV2.Settings.GetBrand:output_type -> cerasusV2.Brand
	22, // 34: cerasusV2.Settings.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	23, // 35: cerasusV2.Settings.GetTaxes:output_type -> cerasusV2.Taxes
	4,  // 36: cerasusV2.Settings.GetMarginLevels:output_type -> cerasusV2.MarginLevels
	24, // 37: cerasusV2.Settings.GetProductWidget:output_type -> cerasusV2.ProductWidgets
	24, // 38: cerasusV2.Settings.GetProductWidgetOrders:output_type -> cerasusV2.ProductWidgets
	25, // 39: cerasusV2.Settings.SetGeoPlace:output_type -> cerasusV2.StatusReply
	25, // 40: cerasusV2.Settings.GetCompanyShops:output_type -> cerasusV2.StatusReply
