...
var file_settings_v2_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x32, 0xf6, 0x05, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
	...
	0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x1a,
	0x17, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x52, 0x6f, 0x75, 0x6e,
	0x64, 0x47, 0x72, 0x61, 0x70, 0x68, 0x69, 0x63, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x0e, 0x47, 0x65,
	...
	0x56, 0x32, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x1a, 0x11, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75,
	0x73, 0x56, 0x32, 0x2e, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x73, 0x22, 0x00, 0x12, 0x36, 0x0a, 0x08,
	...
	0x6e, 0x64, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	0x12, 0x2f, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x54, 0x61, 0x78, 0x65, 0x73, 0x12, 0x0f, 0x2e, 0x63,
	0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x1a, 0x10, 0x2e,
	0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x54, 0x61, 0x78, 0x65, 0x73, 0x22,
	...
	0x75, 0x73, 0x56, 0x32, 0x2e, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21,
...
var file_settings_v2_proto_goTypes = []interface{}{
	...
	(*Brands)(nil),           // 14: cerasusV2.Brands
	(*Brand)(nil),            // 15: cerasusV2.Brand
	(*LineGraphics)(nil),     // 16: cerasusV2.LineGraphics
	(*Taxes)(nil),            // 17: cerasusV2.Taxes
	(*Sales)(nil),            // 18: cerasusV2.Sales
}
var file_settings_v2_proto_depIdxs = []int32{
	...
	6,  // 8: cerasusV2.Settings.GetWeekGraphic:input_type -> cerasusV2.LineGraphRequest
	5,  // 9: cerasusV2.Settings.GetOrderLeaders:input_type -> cerasusV2.Auth
	5,  // 10: cerasusV2.Settings.GetCompanyBrands:input_type -> cerasusV2.Auth
	7,  // 11: cerasusV2.Settings.GetBrand:input_type -> cerasusV2.RequestByID
	8,  // 12: cerasusV2.Settings.GetProductGraphics:input_type -> cerasusV2.RequestByDates
	5,  // 13: cerasusV2.Settings.GetTaxes:input_type -> cerasusV2.Auth
	8,  // 14: cerasusV2.Settings.GetSales:input_type -> cerasusV2.RequestByDates
	9,  // 15: cerasusV2.Settings.Ping:output_type -> cerasusV2.PingReply
	1,  // 16: cerasusV2.Settings.GetUserAppData:output_type -> cerasusV2.UserAppData
	10, // 17: cerasusV2.Settings.GetMainGraphic:output_type -> cerasusV2.LineGraph
	11, // 18: cerasusV2.Settings.GetFlowGraphic:output_type -> cerasusV2.RoundGraphic
	11, // 19: cerasusV2.Settings.GetMarginGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 20: cerasusV2.Settings.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	13, // 21: cerasusV2.Settings.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	14, // 22: cerasusV2.Settings.GetCompanyBrands:output_type -> cerasusV2.Brands
	15, // 23: cerasusV2.Settings.GetBrand:output_type -> cerasusV2.Brand
	16, // 24: cerasusV2.Settings.GetProductGraphics:output_type -> cerasusV2.LineGraphics
	17, // 25: cerasusV2.Settings.GetTaxes:output_type -> cerasusV2.Taxes
	18, // 26: cerasusV2.Settings.GetSales:output_type -> cerasusV2.Sales
