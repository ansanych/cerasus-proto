...
var file_settings_v2_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x32, 0x8a, 0x05, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
...
var file_settings_v2_proto_depIdxs = []int32{
	...
	9,  // 13: cerasusV2.Settings.Ping:output_type -> cerasusV2.PingReply
	1,  // 14: cerasusV2.Settings.GetUserAppData:output_type -> cerasusV2.UserAppData
	10, // 15: cerasusV2.Settings.GetMainGraphic:output_type -> cerasusV2.LineGraph
	11, // 16: cerasusV2.Settings.GetFlowGraphic:output_type -> cerasusV2.RoundGraphic
	11, // 17: cerasusV2.Settings.GetMarginGraphic:output_type -> cerasusV2.RoundGraphic
	12, // 18: cerasusV2.Settings.GetWeekGraphic:output_type -> cerasusV2.WeekGraphic
	13, // 19: cerasusV2.Settings.GetOrderLeaders:output_type -> cerasusV2.OrderLeaders
	14, // 20: cerasusV2.Settings.GetCompanyBrands:output_type -> cerasusV2.Brands
	15, // 21: cerasusV2.Settings.GetBrand:output_type -> cerasusV2.Brand
	16, // 22: cerasusV2.Settings.GetProductGraphics:output_type -> cerasusV2.LineGraphics
