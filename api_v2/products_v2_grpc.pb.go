...
func (c *productsClient) GetProductListByID(ctx context.Context, in *RequestByIDs, opts ...grpc.CallOption) (*ProductList, error) {
	out := new(ProductList)
	err := c.cc.Invoke(ctx, "/cerasusV2.Products/GetProductListByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productsClient) GetOrderLeaders(ctx context.Context, in *Auth, opts ...grpc.CallOption) (*OrderLeaders, error) {
...
func (UnimplementedProductsServer) GetOrderLeaders(context.Context, *Auth) (*OrderLeaders, error) {
...
func _Products_GetProductListByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cerasusV2.Products/GetProductListByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Products_GetOrderLeaders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductsServer).GetOrderLeaders(ctx, req.(*Auth))
	}
	return interceptor(ctx, in, info, handler)
}
