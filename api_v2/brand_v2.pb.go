...
var file_brand_v2_proto_rawDesc = []byte{
	...
	0x93, 0x14, 0x0a, 0x07, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x04, 0x50,
	...
	0x32, 0x2e, 0x53, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x73, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x08, 0x47,
...
var file_brand_v2_proto_depIdxs = []int32{
	...
	28, // 54: cerasusV2.Brander.GetBrand:input_type -> cerasusV2.Auth
	36, // 55: cerasusV2.Brander.UpdateBrand:input_type -> cerasusV2.UpdateBrandRequest
	31, // 56: cerasusV2.Brander.GetCompaniesWithBrandProducts:input_type -> cerasusV2.RequestByPage
	34, // 57: cerasusV2.Brander.SearchSeller:input_type -> cerasusV2.SearchRequest
	19, // 58: cerasusV2.Brander.DeleteProduct:input_type -> cerasusV2.ProductRequest
	34, // 59: cerasusV2.Brander.SearchProduct:input_type -> cerasusV2.SearchRequest
	32, // 60: cerasusV2.Brander.DeleteProductPrice:input_type -> cerasusV2.RequestByID
	11, // 61: cerasusV2.Brander.GetSellerOutProducts:input_type -> cerasusV2.OutProductsRequest
	32, // 62: cerasusV2.Brander.GetSellerOutProduct:input_type -> cerasusV2.RequestByID
	6,  // 63: cerasusV2.Brander.CreateSellerOutProduct:input_type -> cerasusV2.SellerOutProductRequest
	32, // 64: cerasusV2.Brander.DeleteSellerOutProduct:input_type -> cerasusV2.RequestByID
	5,  // 65: cerasusV2.Brander.SellerOutProductSetUrl:input_type -> cerasusV2.SellerOutProductUrlRequest
	32, // 66: cerasusV2.Brander.SellerOutProductDeleteUrl:input_type -> cerasusV2.RequestByID
	37, // 67: cerasusV2.Brander.Ping:output_type -> cerasusV2.PingReply
	4,  // 68: cerasusV2.Brander.GetCountWidgets:output_type -> cerasusV2.BrandCountWidgets
	23, // 69: cerasusV2.Brander.GetSellers:output_type -> cerasusV2.Sellers
	22, // 70: cerasusV2.Brander.GetSeller:output_type -> cerasusV2.Seller
	38, // 71: cerasusV2.Brander.CreateSeller:output_type -> cerasusV2.StatusReply
	38, // 72: cerasusV2.Brander.UpdateSeller:output_type -> cerasusV2.StatusReply
	39, // 73: cerasusV2.Brander.GetSellerCompanies:output_type -> cerasusV2.CompanyList
	14, // 74: cerasusV2.Brander.GetSellerProducts:output_type -> cerasusV2.SellerProducts
	15, // 75: cerasusV2.Brander.GetSellerProduct:output_type -> cerasusV2.SellerProduct
	20, // 76: cerasusV2.Brander.GetProducts:output_type -> cerasusV2.BrandProducts
	38, // 77: cerasusV2.Brander.CreateProduct:output_type -> cerasusV2.StatusReply
	21, // 78: cerasusV2.Brander.GetProduct:output_type -> cerasusV2.BrandProduct
	38, // 79: cerasusV2.Brander.UpdateProduct:output_type -> cerasusV2.StatusReply
	38, // 80: cerasusV2.Brander.LinkSellerProduct:output_type -> cerasusV2.StatusReply
	40, // 81: cerasusV2.Brander.GetImage:output_type -> cerasusV2.ImageReply
	38, // 82: cerasusV2.Brander.UploadFile:output_type -> cerasusV2.StatusReply
	17, // 83: cerasusV2.Brander.GetProductPrice:output_type -> cerasusV2.ProductPrice
	18, // 84: cerasusV2.Brander.GetProductPrices:output_type -> cerasusV2.ProductPrices
	38, // 85: cerasusV2.Brander.SetProductPrice:output_type -> cerasusV2.StatusReply
	1,  // 86: cerasusV2.Brander.SearchDataByCode:output_type -> cerasusV2.DataByCode
	41, // 87: cerasusV2.Brander.GetOrdersGraph:output_type -> cerasusV2.LineGraphics
	42, // 88: cerasusV2.Brander.GetShopsGraph:output_type -> cerasusV2.RoundGraphic
	23, // 89: cerasusV2.Brander.GetSellersData:output_type -> cerasusV2.Sellers
	43, // 90: cerasusV2.Brander.GetBrand:output_type -> cerasusV2.Brand
	38, // 91: cerasusV2.Brander.UpdateBrand:output_type -> cerasusV2.StatusReply
	39, // 92: cerasusV2.Brander.GetCompaniesWithBrandProducts:output_type -> cerasusV2.CompanyList
	23, // 93: cerasusV2.Brander.SearchSeller:output_type -> cerasusV2.Sellers
	38, // 94: cerasusV2.Brander.DeleteProduct:output_type -> cerasusV2.StatusReply
	20, // 95: cerasusV2.Brander.SearchProduct:output_type -> cerasusV2.BrandProducts
	38, // 96: cerasusV2.Brander.DeleteProductPrice:output_type -> cerasusV2.StatusReply
	10, // 97: cerasusV2.Brander.GetSellerOutProducts:output_type -> cerasusV2.OutProducts
	9,  // 98: cerasusV2.Brander.GetSellerOutProduct:output_type -> cerasusV2.OutProduct
	38, // 99: cerasusV2.Brander.CreateSellerOutProduct:output_type -> cerasusV2.StatusReply
	38, // 100: cerasusV2.Brander.DeleteSellerOutProduct:output_type -> cerasusV2.StatusReply
	38, // 101: cerasusV2.Brander.SellerOutProductSetUrl:output_type -> cerasusV2.StatusReply
	38, // 102: cerasusV2.Brander.SellerOutProductDeleteUrl:output_type -> cerasusV2.StatusReply
