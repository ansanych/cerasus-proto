...
var file_pricer_v2_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x32, 0xf8, 0x03, 0x0a, 0x06,
	...
	,
	...
	0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x53,
	...
	0x79, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x1a, 0x12, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x49, 0x44, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_pricer_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pricer_v2_proto_goTypes = []interface{}{
	...
	(*Company)(nil),            // 3: cerasusV2.Company
	(*ParserGetRequest)(nil),   // 4: cerasusV2.ParserGetRequest
	(*ParserSetRequest)(nil),   // 5: cerasusV2.ParserSetRequest
	(*DetectorGetRequest)(nil), // 6: cerasusV2.DetectorGetRequest
	(*DetectorSetRequest)(nil), // 7: cerasusV2.DetectorSetRequest
	(*PingReply)(nil),          // 8: cerasusV2.PingReply
	(*ParserJob)(nil),          // 9: cerasusV2.ParserJob
	(*StatusReply)(nil),        // 10: cerasusV2.StatusReply
	(*DetectorGetReply)(nil),   // 11: cerasusV2.DetectorGetReply
...
var file_pricer_v2_proto_depIdxs = []int32{
	...
	2,  // 1: cerasusV2.Pricer.Ping:input_type -> cerasusV2.PingRequest
	3,  // 2: cerasusV2.Pricer.GetParamsForCounter:input_type -> cerasusV2.Company
	4,  // 3: cerasusV2.Pricer.GetParserData:input_type -> cerasusV2.ParserGetRequest
	5,  // 4: cerasusV2.Pricer.SetParserData:input_type -> cerasusV2.ParserSetRequest
	6,  // 5: cerasusV2.Pricer.GetDetectorData:input_type -> cerasusV2.DetectorGetRequest
	7,  // 6: cerasusV2.Pricer.SetDetectorData:input_type -> cerasusV2.DetectorSetRequest
	3,  // 7: cerasusV2.Pricer.GetProductsWithPricer:input_type -> cerasusV2.Company
	8,  // 8: cerasusV2.Pricer.Ping:output_type -> cerasusV2.PingReply
	1,  // 9: cerasusV2.Pricer.GetParamsForCounter:output_type -> cerasusV2.ParamsForCounter
	9,  // 10: cerasusV2.Pricer.GetParserData:output_type -> cerasusV2.ParserJob
	10, // 11: cerasusV2.Pricer.SetParserData:output_type -> cerasusV2.StatusReply
	11, // 12: cerasusV2.Pricer.GetDetectorData:output_type -> cerasusV2.DetectorGetReply
	10, // 13: cerasusV2.Pricer.SetDetectorData:output_type -> cerasusV2.StatusReply
	12, // 14: cerasusV2.Pricer.GetProductsWithPricer:output_type -> cerasusV2.ReplyID
