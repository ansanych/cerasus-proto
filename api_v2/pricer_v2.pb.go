...
func (x *ProductPricerHistory) GetShopProduct() *ShopProduct {
	if x != nil {
...
func (x *ProductPricerHistory) GetData() []*ShopProductPricerHistory {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pricer_v2_proto_rawDesc = []byte{
	...
	0x22, 0x89, 0x01, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x50, 0x72, 0x69, 0x63,
	0x65, 0x72, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x38, 0x0a, 0x0b, 0x73, 0x68, 0x6f,
	0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16,
	...
	0x75, 0x63, 0x74, 0x12, 0x37, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x23, 0x2e, 0x63, 0x65, 0x72, 0x61, 0x73, 0x75, 0x73, 0x56, 0x32, 0x2e, 0x53, 0x68,
	0x6f, 0x70, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x72, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa0, 0x02, 0x0a,
...
var file_pricer_v2_proto_goTypes = []interface{}{
	...
	(*ProductPricerHistory)(nil),     // 3: cerasusV2.ProductPricerHistory
	(*ProductPricer)(nil),            // 4: cerasusV2.ProductPricer
	(*ProductPricers)(nil),           // 5: cerasusV2.ProductPricers
	(*ShopProduct)(nil),              // 6: cerasusV2.ShopProduct
	(*PingRequest)(nil),              // 7: cerasusV2.PingRequest
	(*Company)(nil),                  // 8: cerasusV2.Company
	(*ParserGetRequest)(nil),         // 9: cerasusV2.ParserGetRequest
	(*ParserSetRequest)(nil),         // 10: cerasusV2.ParserSetRequest
	(*DetectorGetRequest)(nil),       // 11: cerasusV2.DetectorGetRequest
	(*DetectorSetRequest)(nil),       // 12: cerasusV2.DetectorSetRequest
	(*RequestByID)(nil),              // 13: cerasusV2.RequestByID
	(*PingReply)(nil),                // 14: cerasusV2.PingReply
	(*ParserJob)(nil),                // 15: cerasusV2.ParserJob
	(*StatusReply)(nil),              // 16: cerasusV2.StatusReply
	(*DetectorGetReply)(nil),         // 17: cerasusV2.DetectorGetReply
	(*ReplyID)(nil),                  // 18: cerasusV2.ReplyID
}
var file_pricer_v2_proto_depIdxs = []int32{
	0,  // 0: cerasusV2.ParamsForCounter.params:type_name -> cerasusV2.ParamForCounter
	6,  // 1: cerasusV2.ProductPricerHistory.shopProduct:type_name -> cerasusV2.ShopProduct
	2,  // 2: cerasusV2.ProductPricerHistory.data:type_name -> cerasusV2.ShopProductPricerHistory
	3,  // 3: cerasusV2.ProductPricer.history:type_name -> cerasusV2.ProductPricerHistory
	4,  // 4: cerasusV2.ProductPricers.data:type_name -> cerasusV2.ProductPricer
	7,  // 5: cerasusV2.Pricer.Ping:input_type -> cerasusV2.PingRequest
	8,  // 6: cerasusV2.Pricer.GetParamsForCounter:input_type -> cerasusV2.Company
	9,  // 7: cerasusV2.Pricer.GetParserData:input_type -> cerasusV2.ParserGetRequest
	10, // 8: cerasusV2.Pricer.SetParserData:input_type -> cerasusV2.ParserSetRequest
	11, // 9: cerasusV2.Pricer.GetDetectorData:input_type -> cerasusV2.DetectorGetRequest
	12, // 10: cerasusV2.Pricer.SetDetectorData:input_type -> cerasusV2.DetectorSetRequest
	8,  // 11: cerasusV2.Pricer.GetProductsWithPricer:input_type -> cerasusV2.Company
	13, // 12: cerasusV2.Pricer.GetProductPricers:input_type -> cerasusV2.RequestByID
	4,  // 13: cerasusV2.Pricer.SetProductPricer:input_type -> cerasusV2.ProductPricer
	14, // 14: cerasusV2.Pricer.Ping:output_type -> cerasusV2.PingReply
	1,  // 15: cerasusV2.Pricer.GetParamsForCounter:output_type -> cerasusV2.ParamsForCounter
	15, // 16: cerasusV2.Pricer.GetParserData:output_type -> cerasusV2.ParserJob
	16, // 17: cerasusV2.Pricer.SetParserData:output_type -> cerasusV2.StatusReply
	17, // 18: cerasusV2.Pricer.GetDetectorData:output_type -> cerasusV2.DetectorGetReply
	16, // 19: cerasusV2.Pricer.SetDetectorData:output_type -> cerasusV2.StatusReply
	18, // 20: cerasusV2.Pricer.GetProductsWithPricer:output_type -> cerasusV2.ReplyID
	5,  // 21: cerasusV2.Pricer.GetProductPricers:output_type -> cerasusV2.ProductPricers
	16, // 22: cerasusV2.Pricer.SetProductPricer:output_type -> cerasusV2.StatusReply
