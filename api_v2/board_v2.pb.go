...
var file_board_v2_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xbb, 0x02, 0x0a,
...
var file_board_v2_proto_depIdxs = []int32{
	...
	11, // 15: cerasusV2.Board.Ping:output_type -> cerasusV2.PingReply
	6,  // 16: cerasusV2.Board.GetQueues:output_type -> cerasusV2.Queues
	5,  // 17: cerasusV2.Board.GetQueue:output_type -> cerasusV2.Queue
	12, // 18: cerasusV2.Board.ReQueue:output_type -> cerasusV2.StatusReply
	12, // 19: cerasusV2.Board.SetQueueParams:output_type -> cerasusV2.StatusReply
