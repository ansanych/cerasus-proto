...
var file_board_v2_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xc0, 0x02, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74,
	...
	0x6e, 0x69, 0x6e, 0x67, 0x22, 0x2e, 0x0a, 0x06, 0x51, 0x75, 0x65, 0x75, 0x65, 0x73, 0x12, 0x24,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xf4, 0x01, 0x0a, 0x05, 0x42, 0x6f, 0x61, 0x72, 0x64,
...
var file_board_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_board_v2_proto_goTypes = []interface{}{
	...
	(*Queue)(nil),          // 3: cerasusV2.Queue
	(*Queues)(nil),         // 4: cerasusV2.Queues
	(*QueueJob)(nil),       // 5: cerasusV2.QueueJob
	(*QueueJobLog)(nil),    // 6: cerasusV2.QueueJobLog
...
var file_board_v2_proto_depIdxs = []int32{
	7,  // 0: cerasusV2.ReQueueRequest.auth:type_name -> cerasusV2.Auth
	7,  // 1: cerasusV2.QueuesRequest.auth:type_name -> cerasusV2.Auth
	7,  // 2: cerasusV2.QueueRequest.auth:type_name -> cerasusV2.Auth
	5,  // 3: cerasusV2.Queue.jobs:type_name -> cerasusV2.QueueJob
	5,  // 4: cerasusV2.Queue.jobsError:type_name -> cerasusV2.QueueJob
	5,  // 5: cerasusV2.Queue.jobsWarning:type_name -> cerasusV2.QueueJob
	3,  // 6: cerasusV2.Queues.data:type_name -> cerasusV2.Queue
	6,  // 7: cerasusV2.QueueJob.logs:type_name -> cerasusV2.QueueJobLog
	8,  // 8: cerasusV2.Board.Ping:input_type -> cerasusV2.PingRequest
	1,  // 9: cerasusV2.Board.GetQueues:input_type -> cerasusV2.QueuesRequest
	2,  // 10: cerasusV2.Board.GetQueue:input_type -> cerasusV2.QueueRequest
	0,  // 11: cerasusV2.Board.ReQueue:input_type -> cerasusV2.ReQueueRequest
	9,  // 12: cerasusV2.Board.Ping:output_type -> cerasusV2.PingReply
	4,  // 13: cerasusV2.Board.GetQueues:output_type -> cerasusV2.Queues
	3,  // 14: cerasusV2.Board.GetQueue:output_type -> cerasusV2.Queue
	10, // 15: cerasusV2.Board.ReQueue:output_type -> cerasusV2.StatusReply
