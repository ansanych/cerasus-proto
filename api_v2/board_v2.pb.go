...
var file_board_v2_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xd6, 0x01, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74,
	...
	0x65, 0x4a, 0x6f, 0x62, 0x52, 0x04, 0x6a, 0x6f, 0x62, 0x73, 0x22, 0x2e, 0x0a, 0x06, 0x51, 0x75,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xf4, 0x01, 0x0a,
...
var file_board_v2_proto_depIdxs = []int32{
	...
	3,  // 4: cerasusV2.Queues.data:type_name -> cerasusV2.Queue
	6,  // 5: cerasusV2.QueueJob.logs:type_name -> cerasusV2.QueueJobLog
	8,  // 6: cerasusV2.Board.Ping:input_type -> cerasusV2.PingRequest
	1,  // 7: cerasusV2.Board.GetQueues:input_type -> cerasusV2.QueuesRequest
	2,  // 8: cerasusV2.Board.GetQueue:input_type -> cerasusV2.QueueRequest
	0,  // 9: cerasusV2.Board.ReQueue:input_type -> cerasusV2.ReQueueRequest
	9,  // 10: cerasusV2.Board.Ping:output_type -> cerasusV2.PingReply
	4,  // 11: cerasusV2.Board.GetQueues:output_type -> cerasusV2.Queues
	3,  // 12: cerasusV2.Board.GetQueue:output_type -> cerasusV2.Queue
	10, // 13: cerasusV2.Board.ReQueue:output_type -> cerasusV2.StatusReply
