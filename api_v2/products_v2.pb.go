...
var file_products_v2_proto_rawDesc = []byte{
	...
	0xeb, 0x02, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x36, 0x0a, 0x04,
	...
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x23, 0x5a,
...
var file_products_v2_proto_goTypes = []interface{}{
	...
	(*ProductList)(nil),        // 8: cerasusV2.ProductList
}
var file_products_v2_proto_depIdxs = []int32{
	...
	6, // 8: cerasusV2.Products.Ping:output_type -> cerasusV2.PingReply
	7, // 9: cerasusV2.Products.GetProductsCount:output_type -> cerasusV2.Count
	8, // 10: cerasusV2.Products.GetProductList:output_type -> cerasusV2.ProductList
	8, // 11: cerasusV2.Products.GetProductSearch:output_type -> cerasusV2.ProductList
	8, // 12: cerasusV2.Products.GetProductsByShopIDs:output_type -> cerasusV2.ProductList
